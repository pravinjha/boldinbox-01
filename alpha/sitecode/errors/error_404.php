...
<!--------------Load Css------------------------------->
<link href="<?php echo config_item('locker');?>css/inner_red.css?v=6-20-13" rel="stylesheet" type="text/css" /><!--[if IE 6]>
<script src="<?php echo config_item('locker');?>js/DD_belatedPNG_0.0.8a-min.js?v=6-20-13" type="text/javascript"></script>
