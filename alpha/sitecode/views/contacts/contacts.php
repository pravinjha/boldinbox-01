<link rel="stylesheet" href="https://www.boldinbox.com/locker/css/base.css">
<link rel="stylesheet" href="https://www.boldinbox.com/locker/css/utils.css">
<link rel="stylesheet" href="https://www.boldinbox.com/locker/css/dev.css">
<link rel="stylesheet" href="<?php echo $this->config->item('locker').'themes/march2020/';?>scripts/<?php echo $this->router->fetch_class();?>.js" />
...
<!-- body - contacts listing starts -->	
			...
			<div class = 'contacts_section'>				
				<div class = 'contacts_tools'>
					...
					<?php //if( trim($extra['member_id']) != '105'){?>
				...
				<div class = 'contacts_tools_bottom'>
					<div class = 'show_records_per_page'><?php if($extra['manage_contacts'] > 1){ ?>
