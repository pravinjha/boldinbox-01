  ...
  <div id="body-dashborad" class="nobackground">
    <div class="container">
	  ...
	  <tr class="terms_condition"><td colspan="2"><input type="checkbox" name="terms_condition_save" id="terms_condition_save" value="1" style="width:10px;" />			
           I agree to all BoldInbox <a target="_blank" href="<?php echo  base_url().'terms';?>">Terms & Conditions</a>. I agree not to access or otherwise use third party mailing lists or otherwise prepare or send unsolicited email.</td></tr>
		 <tr>
              <td width="100%">
			<?php
		  ...
		  <div class="subscriber_msg" style="display:block ; ">&nbsp;</div>
		   <?php
			echo form_open_multipart('subscriber/create/'.$subscriptions[0]['subscription_id'], array('id' => 'form_subscriber_import','name'=>'form_subscriber_import','class'=>"form-website"));
			?>
