			...
			<div class = 'campaign-block'>
				<div class = 'campaign-info'>
					...
					<div class = 'campaign-info-right'>
						...
						<div class = 'campaign-info-left-status'>
							<strong>Subject: </strong><?php echo ucfirst($campaign['email_subject']);?><br/>
						</div>
               ...
               <?php 
                if($campaign['subscription_list_title']  !=''){  
               		echo "<div class = 'campaign-info-left-status'><strong>Contact Lists: </strong>" .  $campaign['subscription_list_title'] . "</div>";
                } 
                ?>
