...
block_data+=$('#contact_frm_submit').serialize();
	jQuery.ajax({
		url: "<?php echo base_url() ?>subscriber/subscriber_create/<?php echo $subscription_id ?>",
		type:"POST",
		data:block_data,
...
<div class="register-form">
    <div class="registration-page">
        ...
        <tr class="terms_condition"><td><input type="checkbox" name="terms_condition" id="terms_condition" value="1" style="width:10px;" />
           I agree to all BoldInbox <a target="_blank" href="<?php echo  site_url("terms");?>">Terms & Conditions</a>. I agree not to access or otherwise use third party<br/> mailing lists or otherwise prepare or send unsolicited email.</td></tr>
          </table>

      <div class="button_div">
	  <div class="div_add_newrow" id="button">
		<a class="white-drop-button fl contact_frm" onclick="javascript:$('.custom_list').slideToggle();$('.button_div').append('<div class=\'dummy_content\'>&nbsp;</div>');setTimeout( function(){$('.dummy_content').remove()} , 2000);" href="javascript:void(0);"><span >Add New Field <img class="dropsub_img" src="<?php echo $this->config->item('locker');?>images/tab_arrow.png?v=6-20-13" alt="" align="absmiddle" >  </span></a>
