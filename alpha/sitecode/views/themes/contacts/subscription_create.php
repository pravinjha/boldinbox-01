      ...
      <div class="dashboard-home">
		...
		?>
		 <?php
				...
				?>
       	<?php 
			echo form_open('contacts/create', array('id' => 'form_subscription_create','name'=>'form_subscription_create','class'=>"form-website"));
		?>
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
			  ...
			  <td style="width:120px;"  ><?php echo form_button(array('name'=>'campaign_check','class'=>'buttons', 'value'=>'checked','content'=>'checked','onclick'=>"window.location.href='".base_url().'contacts'."'","disabled"=>"disabled")); ?></td>
            </tr>
            <tr>
			...
			<?php
				...
				echo '&nbsp;';
				echo form_button(array('name'=>'campaign_cancel','class'=>'buttons', 'value'=>'Cancel','content'=>'Cancel','onclick'=>"window.location.href='".base_url().'contacts'."'"));
			?>	
			</td>
            </tr> <tr>
              <td class="label">&nbsp;</td>
