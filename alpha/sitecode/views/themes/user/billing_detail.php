...
<?php echo link_tag('locker/css/invoice-style.css?v=6-20-13'); ?>
<script type="text/javascript" src="<?php echo $this->config->item('locker');?>js/jquery-1.5.1.min.js?v=6-20-13"></script>
<script type="text/javascript" src="<?php echo $this->config->item('locker');?>js/fancybox/jquery.fancybox-1.0.0.js?v=6-20-13"></script>
...
<link href="<?php echo $this->config->item('locker');?>js/fancybox/fancy.css?v=6-20-13" rel="stylesheet" type="text/css" />
</head>
<body>
	...
	<div class="wraper ">
      ...
      <div class="header-div">
            	<a href="<?php echo base_url(); ?>"><img src="<?php echo $this->config->item('locker');?>images/logo-blue.png" class="logo" alt="BoldInbox - Simple Easy Clean Email Marketing System" /></a>
  ...
  <tr>
    <th>Details </th>
    <td class="tb2-white">
	<?php if(in_array($user_transactions['user_id'],array(3215, 3333, 3388, 3489, 4252))){?>
	Monthly charge for newsletter editor and service
	<?php }elseif(in_array($user_transactions['transaction_id'],array(12993,12766,12711,2759,8879,8684, 4445, 5531))){?>
	...
	<?php }elseif(in_array($user_transactions['transaction_id'],array(13134, 13108, 12788, 12477, 12469, 11140, 11866, 9770, 9058, 8754,8420,4446, 7199))){?>
	...
	<?php }elseif(in_array($user_transactions['transaction_id'],array(10756,10401,9962,3428,10132))){?>
	...
	Misc. overage charge
	<?php }elseif(in_array($user_transactions['transaction_id'],array(4775))){?>	
	...
	<?php }?>
	<?php if($user_transactions['gateway_response']=="ADMIN") echo "<br/>(Comped by BoldInbox)"; ?></td>
  </tr>
...
<table width="90" border="0" cellspacing="1" cellpadding="0" class="table-div">
  ...
  <?php if($user_transactions['transaction_id'] != 10401) { ?>
   <tr>
    <th>Paid with</th>
    <td class="tb2-white"><?php if(3428 == $user_transactions['transaction_id']){echo 'cash';}else{?>card ending in <?php echo $user_transactions['credit_card_last_digit']; }?></td>
  </tr>
<?php } ?>
</table>
            </div>
...
<?php echo SYSTEM_EMAIL_FROM ;?> </p>
          ...
          <!-- end footer -->
            ...
            <div class="main-bottom"><img src="<?php echo $this->config->item('locker');?>images-front/bottobg.png?v=6-20-13"  alt=""/></div>
        </div>
    </div>
</body>
</html>