...
$arrJSFiles = array(
			'themes/march2020/scripts/vendors/jquery-3.4.1.min.js',
			'themes/march2020/scripts/vendors/jquery-ui.1.12.1.js',
			'themes/march2020/scripts/vendors/jquery.ui.touch-punch.js',			
			'js/nicEdit.js',			
			'js/colorpicker.js',			
			'themes/march2020/scripts/generic.js',
			'themes/march2020/scripts/site.js'
			);
...
var handler='<div class="handler_ul_div"><ul style="list-style: none outside none;" class="handler"><li class="alignright"><a class="close-link" ><img src="<?php echo base_url() ?>locker/images/cross-script.png?v=6-20-13" title="Delete" /></a></li><li class="drag-center" ><a class="drag_handler"><img src="<?php echo base_url() ?>locker/images/drag.png?v=6-20-13" title="Drag"/></a></li></ul></div>';		//Blocks handler

// var handler_active_img = "<li><a  class='option_image-link'><img src='<?php echo base_url() ?>locker/images/icons/add_link.png' title='Add Link'/></a></li><li ><a  class='option_image-caption' ><img src='<?php echo base_url() ?>locker/images/icons/caption.png' title='Add Caption'/></a></li>";
var handler_active_img = "<li ><a  class='option_image-caption' ><img src='<?php echo base_url() ?>locker/images/icons/caption.png' title='Add Caption'/></a></li>";

var handler_image1="<div class='handler_img'><ul><li><a  class='clone_image' ><img src='<?php echo base_url() ?>locker/images/icons/add.png' title='Add'/></a></li></ul></div><div class='handler_img_width_height'></div>";		//1 image  handler

var handler_image2="<div class='handler_img'><ul><li><a  style='margin:0px' class='close-clone-link'><img src='<?php echo base_url() ?>locker/images/icons/delete.png' title='Delete'/></a></li><li><a  class='clone_image' ><img src='<?php echo base_url() ?>locker/images/icons/add.png' title='Add'/></a></li></ul></div><div class='handler_img_width_height'></div>";		//2 images handler

var handler_image3="<div class='handler_img'><ul><li><a  class='option_image-link'><img src='<?php echo base_url() ?>locker/images/icons/add_link.png' title='Add Link'/></a></li><li><a  class='option_image-caption' ><img src='<?php echo base_url() ?>locker/images/icons/caption.png' title='Add Caption'/></a></li><li><a  style='margin:0px' class='close-clone-link'><img src='<?php echo base_url() ?>locker/images/icons/delete.png' title='Delete'/></a></li><li><a  class='clone_image' ><img src='<?php echo base_url() ?>locker/images/icons/add.png' title='Add'/></a></li></ul></div><div class='handler_img_width_height'></div>";		//3 images  handler

var handler_image4="<div class='handler_img'><ul><li><a  style='margin:0px' class='close-clone-link'><img src='<?php echo base_url() ?>locker/images/icons/delete.png' title='Delete'/></a></li></ul></div><div class='handler_img_width_height'></div>";	//4 images  handler

var handler_image_text="<div class='handler_img'><ul><li><a  class='option_image-link'><img src='<?php echo base_url() ?>locker/images/icons/add_link.png' title='link'/></a></li><li><a  class='option_image-caption' style='float:left;'><img src='<?php echo base_url() ?>locker/images/icons/caption.png' title='caption'/></a></li><li><a  class=\"change-pos\" style=\"float:left;\"><img src='<?php echo base_url() ?>locker/images/icons/align_right.png?v=6-20-13' title='Right align'/></a></li></ul></div><div class='handler_img_width_height'></div><div class='handler_img_width_height'></div>";	//image with text block  handler
...
function drag_drop(){
	...
	jQuery( ".drop" ).sortable({
		...
		update: function(e, ui){
			...
			if (ui.item.children().hasClass('block-text'))					fnTextBlock(ui.item);
			if (ui.item.children().hasClass('block-offer'))				fnOfferBlock(ui.item);
			if (ui.item.children().hasClass('block-image'))				fnImageGroupBlock(ui.item);
			if (ui.item.children().hasClass('block-image-text'))			fnImageTextBlock(ui.item);
			if (ui.item.children().hasClass('block-button'))				fnButtonBlock(ui.item);
			if (ui.item.children().hasClass('block-table'))				fnTableBlock(ui.item);			
			if (ui.item.children().hasClass('block-divider-rule'))			fnDividerRule(ui.item);
			if (ui.item.children().hasClass('block-social-media'))			fnSocailMedia(ui.item);
			if (ui.item.children().hasClass('block-youtube'))				fnYoutubeBlock(ui.item);
			jQuery('.save_campaign').removeClass('disable-link');	// enable save link
			pagechange=true;	//Page content change
		}
	});
	jQuery( ".block,.block-image,.block-text,.block-offer,.block-image-text,.block-table,.block-button, .block-title, .block-image-group,.block-social-media,.block-youtube,.block-divider-rule" ).draggable({ connectToSortable: ".drop",helper: function() {
	var $this= $(this);
...
function fnButtonBlock(thisBlock){
	...
	displayAlertMessageAdvance('Add a Button to Your Campaign',$("#btn_dialog").html(),'2','fn:removeGarbage');
...
function addButton(){
	...
	$('#'+btn_block_id).find('.handler_div').prepend('<div class="handler_ul_div"><ul style="list-style: none outside none;" class="handler"><li class="alignright"><a class="close-link" ><img src="<?php echo base_url() ?>locker/images/cross-script.png?v=6-20-13" title="Delete" /></a></li><li><a title="Edit"  class="edit_btn">edit</a></li><li class="drag-center" ><a class="drag_handler"><img src="<?php echo base_url() ?>locker/images/drag.png?v=6-20-13" title="Drag"/></a></li></ul></div>');
	$('.empty_block').removeClass('empty_block');
	pagechange=true;	//Page content change
}
$(document).on('click','.edit_btn', function(){
	...
	displayAlertMessageAdvance('Edit this button',$("#btn_dialog").html(),'2','');
...
function fnTableBlock(thisBlock){
	...
	displayAlertMessageAdvance('Insert a Table',$("#tbl_dialog").html(),'2','fn:removeGarbage');
	$( "#message" ).html(  ); 	
...
function fnImageGroupBlock(thisBlock){
	...
	displayAlertMessageAdvance('Add Image(s) to Your Campaign',$("#image_group_dialog").html(),'2','fn:removeGarbage');
...
function fnDividerRule(thisBlock){
	...
	$('.empty_block').removeClass('empty_block');
	thisBlock.after("<table width='100%' cellspacing='0' cellpadding='0' class='container-div divider_block' id='"+bid+"' ><tr><td  class='handler_div' align='center'><hr style='width:547px;margin:5px 0;padding:0;border-top: 1px solid #CCC;' /></td></tr></table>");
	thisBlock.remove();
	var handler_block=handler.replace('[colspan]','1');
...
function fnSocailMedia(thisBlock){
	...
	$.ajax({type: "POST", cache: false, url: base_url+'promotions/get_socialmedia_ajax/', success: function(data) {
		displayAlertMessageAdvance('Add Social Media to Your Campaign',data,'2','fn:removeGarbage');
	} });
	$("#current_container_id").val(img_id);		// set block id
	pagechange=true;	//Page content change
}
...
function fnYoutubeBlock(thisBlock){
	...
	thisBlock.attr('id',img_id);
	displayAlertMessageAdvance('Add a Video to Your Campaign',$("#youtube_edit_dialog").html(),'2','fn:removeGarbage');
	$("#current_container_id").val(img_id);		// set block id
	pagechange=true;	//Page content change
}
/**
	function saveImageGroupOption to insert  images-block in campaign 
**/
function saveImageGroupOption(img_count){	
	...
	if(img_count==1){
		...
		$('.empty_block').removeClass('empty_block');
		jQuery("#"+top_div).after("<table width='100%' cellspacing='0' cellpadding='0' class='container-div' id='"+im+"'><tr><td  class='handler_div' align='center'><table  align='center' class='resize_table' cellpadding='0' cellspacing='0'><tr><td align='left' class='img_content' id='"+im+"_1' valign='top'><div class='position_div'><img src='<?php echo base_url() ?>locker/images/contentBuilderEmailContentDrop.jpg?v=1.0' rel='blank' class='image-container drop-image' alt='Campaign-Image' width='265' height='265'  name='1' border='0'/><div class='resize_div ' style='width: 265px; height: 265px;'><div  class='div_border'><span style='display:none;' class='drop_div_border'></span></div><div  class='highlight_on_image_hover'><span style='display:none;' class='drop_div_border'></span></div></div></div><div class=\"active_image_option\"><span class='img_link_span'><img src='<?php echo base_url() ?>locker/images/icons/add_link.png' width = '16' class='image_link' style='display:none;'/></span></div><div><span class='image_caption'></span></div></td></tr></table></td></tr></table>");
		jQuery("#"+top_div).remove();
		var handler_block=handler.replace('[colspan]','1');
		...
		var im='block_'+new Date().getTime();		
		$('.empty_block').removeClass('empty_block');
		jQuery("#"+top_div).after("<table width='100%' cellspacing='0' cellpadding='0' class='container-div' id='"+im+"'><tr><td  class='handler_div'><table  align='center' class='resize_table' cellspacing='0' cellpadding='0'><tr><td align='left' class='img_content' id='"+im+"_1' valign='top' ><div class='position_div'><img src='<?php echo base_url() ?>locker/images/contentBuilderEmailContentDrop.jpg?v=1.0' rel='blank' class='image-container drop-image' alt='Campaign-Image' width='265' height='265' name='1' border='0' /><div class='resize_div ' style='width: 265px; height: 265px; '><div  class='div_border'><span style='display:none;' class='drop_div_border'></span></div><div  class='highlight_on_image_hover'><span style='display:none;' class='drop_div_border'></span></div></div></div><div class=\"active_image_option\"><span class='img_link_span'><img src='<?php echo base_url() ?>locker/images/icons/add_link.png' class='image_link' style='display:none;'/></span></div><div><span class='image_caption'></span></div></td><td align='left' class='img_content' id='"+im+"_2' valign='top' ><div class='position_div'><img src='<?php echo base_url() ?>locker/images/contentBuilderEmailContentDrop.jpg?v=1.0' rel='blank' class='image-container drop-image' alt='Campaign-Image' border='0'  width='265' height='265'  name='1' /><div class='resize_div ' style='width: 265px; height: 265px;'><div class='div_border'><span style='display:none;' class='drop_div_border'></span></div><div  class='highlight_on_image_hover'><span style='display:none;' class='drop_div_border'></span></div></div></div><div class=\"active_image_option\"><span class='img_link_span'><img src='<?php echo base_url() ?>locker/images/icons/add_link.png' class='image_link' style='display:none;'/></span></div><div><span class='image_caption'></span></div></td></tr></table></td></tr></table>");
		jQuery("#"+top_div).remove();
		...
		var im='block_'+new Date().getTime();		
		$('.empty_block').removeClass('empty_block');
		jQuery("#"+top_div).after("<table width='100%' cellspacing='0' cellpadding='0' class='container-div' id='"+im+"'><tr><td  class='handler_div'><table  align='center' class='resize_table' cellspacing='0' cellpadding='0'><tr><td align='left' class='img_content' id='"+im+"_1'  valign='top'><div class='position_div'><img src='<?php echo base_url() ?>locker/images/contentBuilderEmailContentDrop.jpg?v=1.0' rel='blank' class='image-container drop-image' alt='Campaign-Image' width='168' height='168' border='0' name='1' /><div class='resize_div ' style='width: 168px; height: 168px; '><div class='div_border'><span style='display:none;' class='drop_div_border'></span></div><div  class='highlight_on_image_hover'><span style='display:none;' class='drop_div_border'></span></div></div></div><div class=\"active_image_option\"><span class='img_link_span'><img src='<?php echo base_url() ?>locker/images/icons/add_link.png' class='image_link' style='display:none;'/></span></div><div><span class='image_caption'></span></div></td><td align='left' class='img_content' id='"+im+"_2'  valign='top'><div class='position_div'><img src='<?php echo base_url() ?>locker/images/contentBuilderEmailContentDrop.jpg?v=1.0' rel='blank' class='image-container drop-image' alt='Campaign-Image' border='0' width='168' height='168' name='1' /><div class='resize_div ' style=' width: 168px; height: 168px;'><div class='div_border'><span style='display:none;' class='drop_div_border'></span></div><div  class='highlight_on_image_hover'><span style='display:none;' class='drop_div_border'></span></div></div></div><div class=\"active_image_option\"><span class='img_link_span'><img src='<?php echo base_url() ?>locker/images/icons/add_link.png' class='image_link' style='display:none;'/></span></div><div><span class='image_caption'></span></div></td><td align='left' id='"+im+"_3' class='img_content'   valign='top'><div class='position_div'><img src='<?php echo base_url() ?>locker/images/contentBuilderEmailContentDrop.jpg?v=1.0' rel='blank' class='image-container drop-image' alt='Campaign-Image' border='0' width='168' height='168' name='1' /><div class='resize_div ' style='width: 168px; height: 168px;'><div  class='div_border'><span style='display:none;' class='drop_div_border'></span></div><div  class='highlight_on_image_hover'><span style='display:none;' class='drop_div_border'></span></div></div></div><div class=\"active_image_option\"><span class='img_link_span'><img src='<?php echo base_url() ?>locker/images/icons/add_link.png' class='image_link' style='display:none;'/></span></div><div><span class='image_caption'></span></div></td></tr></table></td></tr></table>");
		jQuery("#"+top_div).remove();
		...
		var im='block_'+new Date().getTime();
		$('.empty_block').removeClass('empty_block');		
		jQuery("#"+top_div).after("<table width='100%' cellspacing='0' cellpadding='0' class='container-div' id='"+im+"'><tr><td  class='handler_div'><table  align='center' class='resize_table' cellspacing='0' cellpadding='0'><tr><td align='left' id='"+im+"_1' class='img_content' valign='top' ><div class='position_div'><img src='<?php echo base_url() ?>locker/images/contentBuilderEmailContentDrop.jpg?v=1.0' rel='blank' width='120' height='120' class='image-container drop-image' alt='Campaign-Image' border='0'  name='1'/><div class='resize_div ' style='width: 120px; height: 120px;'><div class='div_border'><span style='display:none;' class='drop_div_border'></span></div><div  class='highlight_on_image_hover'><span style='display:none;' class='drop_div_border'></span></div></div></div><div class=\"active_image_option\"><span class='img_link_span'><img src='<?php echo base_url() ?>locker/images/icons/add_link.png' class='image_link' style='display:none;'/></span></div><div><span class='image_caption'></span></div></td><td align='left' id='"+im+"_2' class='img_content'  valign='top' ><div class='position_div'><img src='<?php echo base_url() ?>locker/images/contentBuilderEmailContentDrop.jpg?v=1.0' rel='blank' class='image-container drop-image' alt='Campaign-Image' border='0' width='120' height='120'  name='1'/><div class='resize_div ' style='width: 120px; height: 120px; '><div  class='div_border'><span style='display:none;' class='drop_div_border'></span></div><div  class='highlight_on_image_hover'><span style='display:none;' class='drop_div_border'></span></div></div></div><div class=\"active_image_option\"><span class='img_link_span'><img src='<?php echo base_url() ?>locker/images/icons/add_link.png' class='image_link' style='display:none;'/></span></div><div><span class='image_caption'></span></div></td><td align='left' id='"+im+"_3' class='img_content'  valign='top' ><div class='position_div'><img src='<?php echo base_url() ?>locker/images/contentBuilderEmailContentDrop.jpg?v=1.0' rel='blank' class='image-container drop-image' alt='Campaign-Image' border='0' width='120' height='120' name='1'/><div class='resize_div ' style=' width: 120px; height: 120px; left: 0px; top: 0px;'><div  class='div_border'><span style='display:none;' class='drop_div_border'></span></div><div  class='highlight_on_image_hover'><span style='display:none;' class='drop_div_border'></span></div></div></div><div class=\"active_image_option\"><span class='img_link_span'><img src='<?php echo base_url() ?>locker/images/icons/add_link.png' class='image_link' style='display:none;'/></span></div><div><span class='image_caption'></span></div></td><td align='left' id='"+im+"_4' class='img_content'  valign='top' ><div class='position_div'><img src='<?php echo base_url() ?>locker/images/contentBuilderEmailContentDrop.jpg?v=1.0' rel='blank' class='image-container drop-image' alt='Campaign-Image' border='0' width='120' height='120' name='1'/><div class='resize_div ' style='width: 120px; height: 120px;'><div class='div_border'><span style='display:none;' class='drop_div_border'></span></div><div  class='highlight_on_image_hover'><span style='display:none;' class='drop_div_border'></span></div></div></div><div class=\"active_image_option\"><span class='img_link_span'><img src='<?php echo base_url() ?>locker/images/icons/add_link.png' class='image_link' style='display:none;'/></span></div><div><span class='image_caption'></span></div></td></tr></table></td></tr></table>");
		jQuery("#"+top_div).remove();
	...
	$('.empty_block').removeClass('empty_block');
	closeAlertMessage();
	setTimeout('dragDropImageBank()', 1000);	// This 
}
/**
...
$('#messageBox').find('.youtube_msg').html("Please wait...");
	...
	if(matches){
		...
		if(url!=""){
			...
			var ytApiKey = "AIzaSyB5ebLju4sES305LXwJqbUHr_8ijs3ydfQ";	 
...
function youtubeFeedCallback(json){
	if(typeof json["error"] !== 'undefined'){
		close_youtube();
		displayAlertMessageAdvance('','<div style="display:block;margin:20px;">Right now, we are unable to get video details for this URL.</div>','0','fn:removeGarbage');
	}else{
	$('.diy_demo_video').remove();
...
function vimeoVideoUrlUpdate(){
	...
	jQuery.ajax({
		...
		success: function(data) {
			...
			if(data_obj.error){
				$('#messageBox').find('.youtube_msg').show();
				$('#messageBox').find('.youtube_msg').html(data_obj.error);
				setTimeout( function(){$('#messageBox').find('.youtube_msg').fadeOut();} , 4000);
			}else{
				...
				$("#"+top_div).after("<table width='100%' cellspacing='0' cellpadding='0' class='container-div youtube_container' id='"+vmid+"' name='"+url+"'><tr><td  class='handler_div'><table style='width:550px;' border='0' align='center' class='resize_table'><tr><td align='center' class='img_content' id='"+vmid+"_1' valign='top'><div class='position_div' style=\"position:relative;text-align:center;display:inline-block;\"><img src='"+vimeo_video_url+"' class='image-container drop-image' alt='Campaign-video' width='480'  border='0' /><div class='video_play' style=\"position: absolute;top: 80px;left: 103px;width: 58px;height: 41px;background-image: url('<?php echo $this->config->item('locker');?>images/play.png?v=6-20-13')\"></div><div class='resize_div ' style='position: absolute; text-align: center; width: 480px; height: 0px; left: 0px; top: 0px; z-index: 10; border-color: transparent;'><div style='display: block; position: absolute; top: -1px; bottom: -1px; right: -1px; left: -1px; border: 1px solid rgb(240, 240, 240);' class='div_border'><span style='display:none;' class='drop_div_border'></span></div></div></div><img src='<?php echo base_url() ?>locker/images/icons/add_link.png' class='image_link' style='display:none;'/><span class='youtube_image_caption'></span></td></tr></table></td></tr></table>");
				var handler_block=handler.replace('[colspan]','1');
				$('#'+vmid).find('.handler_div').prepend(handler_block);
				$('#'+vmid).find('.resize_div').prepend(handler_youtube);
				$("#"+vmid).find('.youtube_image_caption').html(data_obj.title);
				$("#"+vmid).find('.image_link').attr('title',url);
...
function saveImageCaption(){	
	...
	//$('#active_block').attr("id",""); // Commented on @30April2020 to merge camption and link box.
...
function loadHeaderEffect(){
	...
	if($('.empty_header').length>0){
		if(jQuery("#current_template_id").val()!=-1){
			var header_img_path='<img src="<?php echo $this->config->item('locker');?>header-images/header-'+jQuery("#current_template_id").val()+'.jpg" border="0" class="header_img" alt="campaign header"  />';
			jQuery('#header').append(header_img_path);
			jQuery('.empty_header').remove();
		}else{
			$('.empty_header').html('<img src="<?php echo $this->config->item('locker');?>images/contentBuilderHeader.jpg?v=1.0" />');
			...
			$('.header_unlink').remove();
			$('.header_unlink').parent().remove();
		}
	}
...
/**
	Function to drag-drop IMAGE from image-bank to Image-block or to Header-block
**/
	...
	jQuery( ".position_div,#header" ).droppable({
		...
		drop: function( event, ui ) {
			...
			if(jQuery(this).find('.header_div').length>0){
				var header_img='<img border="0" class="header_img" src="'+img_src+'" width="595" height="auto" alt="campaign header" />';
				...
				// When image placed......add more tools on top
				jQuery(this).find('.resize_div .handler_img ul').prepend(handler_active_img);
				// Mark img-block as nonblank
				jQuery(this).find('.image-container').attr('rel','nonblank');
...
function organizeImageBank_bekaar() {
	$('.img-bank').masonry({
...
function organizeImageBank_sample() {
    var grid = $('.img-bank');    
...
saveHeader=function(template_id){
	...
	var header_img_path='<img src="<?php echo $this->config->item('locker');?>images/template-headers/'+template_id+'.jpg" border="0" class="header_img" alt="campaign header" width="595" height="auto" />';
	jQuery('#header').append(header_img_path);
	jQuery('.empty_header').remove();
	$('.header_div').find('.menu').remove();
	$('.header_div').prepend(handler_header);
...
function addHeaderLink(){
	if($('#messageBox').find("#header_link_text").val()){
		...
		$('.header_div').prepend('<div id="header_link"><img class="header_link_show" name="'+link_url+'"  title="'+link_url+'" src="<?php echo base_url();?>locker/images/icons/add_link.png"/></div>');
	}else{
		$('#header_link').remove();
	}
	closeAlertMessage();
...
function imageBankDisplay(){
	...
	jQuery.ajax({
			url: "<?php echo base_url() ?>promotions/get_image_bank_for_ajax/image_bank_cards",
			type:"POST",
			success: function(data) {
				$('.img-bank2').html(data);
				dragDropImageBank();
...
/**
	Function to save imagebank's images url - NOT WORKING 26April,2020
**/
	...
	jQuery.ajax({
		...
		success: function(data) {
			...
			if(error=="true"){
				...
				var li_class_name=$('#messageBox').find(".img-bank2  li:last-child").attr("class");
				var li_name=img_path+','+img_width+','+img_height;
				li_class_name='class="li_draggable" ';
				var img_remove='<div  class="del_image_link2"><a href="javascript:void(0);"  class="remove-img-link image_bank_unlink" id="'+img_id+'" title="Delete"><i class="icon-remove"></i></a></div>';
				var img_html='<div  class="image_div"><img class="image_bank_div2 draggable1" src="'+img_path+'?a='+'block_'+new Date().getTime()+'" name="'+li_name+'"   /></div>';
				var thumb_img_html='<img  src="'+thumb_img_path+'"  />';
				parent.$('.load_images').remove();
				parent.$('.img-bank2').append('<li '+li_class_name+'  title="Click & Drag"><div  class="img_slide2" >'+img_remove+img_html+'</div></li>');
				closeAlertMessage();
			}
			dragDropImageBank();
		}
...
**/
$(document).on('change','#twitter_link', function(){ ($(this).is(':checked'))?	$('#messageBox').find('#twitter_url').show() : 	$('#messageBox').find('#twitter_url').hide();	});
$(document).on('change','#facebook_link', function(){ ($(this).is(':checked'))?	$('#messageBox').find('#facebook_url').show() : 	$('#messageBox').find('#facebook_url').hide();	});
$(document).on('change','#linkedin_link', function(){ ($(this).is(':checked'))?	$('#messageBox').find('#linkedin_url').show() : 	$('#messageBox').find('#linkedin_url').hide();	});
$(document).on('change','#rss_link', function(){ ($(this).is(':checked'))?	$('#messageBox').find('#rss_url').show() : 	$('#messageBox').find('#rss_url').hide();	});
$(document).on('change','#youtube_link', function(){ ($(this).is(':checked'))?	$('#messageBox').find('#youtube_url').show() : 	$('#messageBox').find('#youtube_url').hide();	});
$(document).on('change','#google_plus_link', function(){ ($(this).is(':checked'))?	$('#messageBox').find('#google_plus_url').show() : 	$('#messageBox').find('#google_plus_url').hide();	});
$(document).on('change','#tumblr_link', function(){ ($(this).is(':checked'))?	$('#messageBox').find('#tumblr_url').show() : 	$('#messageBox').find('#tumblr_url').hide();	});
$(document).on('change','#flickr_link', function(){ ($(this).is(':checked'))?	$('#messageBox').find('#flickr_url').show() : 	$('#messageBox').find('#flickr_url').hide();	});
$(document).on('change','#skype_link', function(){ ($(this).is(':checked'))?	$('#messageBox').find('#skype_url').show() : 	$('#messageBox').find('#skype_url').hide();	});
$(document).on('change','#pinterest_link', function(){ ($(this).is(':checked'))?	$('#messageBox').find('#pinterest_url').show() : 	$('#messageBox').find('#pinterest_url').hide();	});
$(document).on('change','#instagram_link',function(){ ($(this).is(':checked'))?	$('#messageBox').find('#instagram_url').show() : 	$('#messageBox').find('#instagram_url').hide();	});
$(document).on('change','#mailto_link', function(){ ($(this).is(':checked'))?	$('#messageBox').find('#mailto_url').show() : 	$('#messageBox').find('#mailto_url').hide();	});
$(document).on('change','#website_link', function(){ ($(this).is(':checked'))?	$('#messageBox').find('#website_url').show() : 	$('#messageBox').find('#website_url').hide();	});
...
(function($) {
$(document)
	.on('click','.close-link',function(event){
pagechange=true;	
		var confirm_msg=$("#confirm_msg").html();
		if($(this).hasClass('logo_class')){
			$(this).parents('#logo').find('.logo_img').attr('id','active_logo');
			confirm_msg=confirm_msg.replace('block','logo');
		}else if($(this).hasClass('theme_color_delete')){			
			$(this).parent().parent('div').addClass('active_theme_color');		
			confirm_msg=confirm_msg.replace('block','theme');
		}else if($(this).hasClass('image_bank_unlink')){
			$(this).parent('div').attr('id','active_image_bank');
		}else if($(this).hasClass('header_unlink')){
			$(this).parents('#header').find('.header_img').attr('id','active_header');
			confirm_msg=confirm_msg.replace('block','banner'); 			
		}else{
			$(this).parents('.container-div').attr('id','active_block');
		}
		
displayAlertMessageAdvance('Please Confirm',confirm_msg,'2','fn:removeGarbage');
	});  
})(jQuery);	
	
jQuery(document).on('click','.remove-img-link',function(event){
		/* added on 30.04.2020 for image delete from gallery */		
		if($(this).attr('rel') == 'image_gallery'){
			if(confirm('Are you sure you want to delete this image?')){
				var image_id=this.id;
				// alert(image_id);
				unlinkImageBank(image_id);
				jQuery(".add_logo").click();
				imageBankDisplay();
			}else{
				return false;
			}
...
$(document).on('click','#messageBox .delete-block', function(event){
		...
		if($('#active_logo').length>0){
			...
			$('.header_div').append('<span class="empty_header"><img src="<?php echo $this->config->item('locker');?>images/contentBuilderHeader.jpg?v=1.0" width="595"/></span>');
			var delay = function() { setHeaderHeight(); };
			setTimeout(delay, 1000);
...
**/
$(document).on('click', '.clone_image', function(event){
	...
	img_container.each(function() {
		...
		if(i==4){ 
			...
			$(this).find('.image-container').attr('rel','blank');
			...
			//if($(this).find('.image-container').attr('rel') == 'nonblank')$(this).find('.resize_div ul').prepend(handler_active_img);
...
**/
$(document).on('click','.close-clone-link', function(event){
	var parent_obj_id=$(this).parents('.container-div').attr('id');
...
// NOT IN USE
/*
jQuery(document).on('click','.option_image-caption', function(){
	jQuery(this).attr('id','active_block');
	var image_caption=jQuery(this).parents('.img_content').find('.image_caption').html();	
	displayAlertMessageAdvance('Add a Caption to Your Image', $("#image_caption").html(), '2','');
...
jQuery(document).on('click','.option_image-caption', function(){
	jQuery(this).attr('id','active_block');
	var image_caption=jQuery(this).parents('.img_content').find('.image_caption').html();	
	displayAlertMessageAdvance('Add a Caption and or Link to Your Image', $("#image_caption_link").html(), '2','');
	
	$('#messageBox').find("textarea#image_link_caption").val(image_caption);	//set caption in textarea
	
	var header_lnk_url = (undefined == jQuery(this).parents('.img_content').find('.image_link').attr('name')) ? '' : 	jQuery(this).parents('.img_content').find('.image_link').attr('name');
	header_lnk_url = ( -1 == header_lnk_url.indexOf('http'))? 'http://'+header_lnk_url : header_lnk_url;
	if(header_lnk_url == 'http://') header_lnk_url = '';
	$('#messageBox').find("#image_link").val(header_lnk_url);
...
**/
jQuery(document).on('click','.option_image-link',function(){
	jQuery(this).attr('id','active_block');	
	displayAlertMessageAdvance('Add a Link to Your Image', $("#image_option").html(), '2','');
...
function changeHeader(param){
	...
	if(param == 'initiate'){		
		displayAlertMessageAdvance('Change Header Image', "<div style='text-align:center'><img src='"+base_url+"locker/images/icons/ajax-loader.gif' style = 'width:43px !important;'  /></div>", '0', '');
	}			
	$.ajax({
        type        : "POST",
        cache       : false,
        url         : base_url+'promotions/get_theme_data_for_ajax/'+cat,        
        success: function(data) {		
			$( "#message" ).html( data ); 			
        }
    });
...
jQuery(document).on('click','.select_theme', function(e){
	changeHeader('initiate');	
});

/**
	Open popup  for  header link
**/
jQuery(document).on('click', '.header_link',function(){	
	displayAlertMessageAdvance('Add a Link to Header',$("#header_link_option").html(),'2','');	
	var header_lnk_url = (undefined == jQuery('#header_link').find('img').attr('name')) ? '' : 	jQuery('#header_link').find('img').attr('name');
	header_lnk_url = ( -1 == header_lnk_url.indexOf('http'))? 'http://'+header_lnk_url : header_lnk_url;
	if(header_lnk_url == 'http://') header_lnk_url = '';
	$('#messageBox').find("#header_link_text").val(header_lnk_url);
});
/**
	Open popup for logo-img upload
jQuery(document).on('click','.add_logo',function(){	
	displayAlertMessageAdvance('Add a Logo to Header', $("#logo_dialog").html(),'0','');
...
jQuery(document).on('click','.add_logo',function(){	
	...
	jQuery.ajax({
			url: "<?php echo base_url() ?>promotions/get_image_bank_for_ajax/gallery_pop",
			type:"POST",
			success: function(data) {
				// bibAlert(data);			return false;
				//"<ul class=\"gallery_pop\">"+data+"</ul>"		
				displayAlertMessageAdvance('Add a Logo to Header', "<div class = 'upload_image_bank' rel = 'add_logo_popup' align = 'center'><a style = 'margin:auto;' href = 'javascript:void(0);' class = 'buttonSm'> + Click to Upload Your Image</a></div>" + data ,'','');
				//organizeImageBank();
			}
	});
});
jQuery(document).on('click','#messageBox .draggable1',function(e, ui){	
	var img_src=$(this).attr('src');
	var logo=logo_header.replace('[logo_src]',img_src+'?a='+'block_'+new Date().getTime());
	var img_id=$(this).attr('rel');
	$('.header_div #logo').remove();
	$('.header_div').prepend(logo);
	pagechange=true;
	jQuery.ajax({url: "<?php echo base_url() ?>promotions/used_image_bnk_img/"+img_id, type:"POST",success: function(data) {} });
	closeAlertMessage();
	loadLogoEffect();
});
/**
	Upload Logo
**/
jQuery(document).on('change','#logo_file', function(){	
	$('#logo').remove();
	if(campaign_text == "auotresponder") var ctyp = 'a'; else var ctyp = 'c';
		var fd = new FormData();				
		var files = $('#logo_file')[0].files[0];
		fd.append('logo_file',files);

		// AJAX request
		$.ajax({ url: base_url+'ajax/upload_diy_logo/'+ctyp+'/'+email_campaign_id, type: 'post', data: fd, contentType: false, processData: false,
				success: function(data){	
					var data_arr=data.split(':');
					if(data_arr[0]=="error"){
						bibAlert(data_arr[1]);
					}else{
						var logo=logo_header.replace('[logo_src]',data_arr[1]+'?a='+'block_'+new Date().getTime());
						$('.header_div').prepend(logo);
						closeAlertMessage();
						loadLogoEffect();
					}
...
**/
jQuery(document).on('click','.upload_image_bank',function(){	
	$.ajax({
        type        : "POST",
        cache       : false,
        ...
        success: function(data) {
			if(data == 'ok'){
				var btn = ($('.upload_image_bank').attr('rel') == 'add_logo_popup') ? '<button type="button" class="btn btn-primary add_logo">Image Gallery</button>' : '0';
				if(jQuery(this).find('img').length==0){
					if(btn != '0'){$("#upload_image_bank_dialog .image_bank_file_container").attr('rel','add_logo_popup');}else{$("#upload_image_bank_dialog .image_bank_file_container").attr('rel','');}
					displayAlertMessageAdvance('Browse & Upload Your Image',$("#upload_image_bank_dialog").html(),btn,'');
				}
			}else{				
				displayAlertMessageAdvance('',$("#block_upload_image_bank_dialog").html(),'0','');				
			}
        }
    });
...
/**
*	Upload image in Image Bank
*/
$(document).on('dragover','#image_bank_file', function(){
	$('#image_bank_file').addClass('highlight');	
});
$(document).on('dragleave','#image_bank_file', function(){
	$('#image_bank_file').removeClass('highlight');	
});
$(document).on('change','#image_bank_file', function(){
	$('#messageBox').find('.img_upload_msg').show();
	$('#messageBox').find('.img_upload_msg').html("Please wait...");
	//$('#messageBox').find('.img_upload_msg').addClass('error');
	...
	var totalfiles = document.getElementById('image_bank_file').files.length;
	for (var i = 0; i < totalfiles; i++) {
	  fd.append("files[]", document.getElementById('image_bank_file').files[i]);
	}
	...
	$.ajax({ url: base_url+'ajax/upload_image_bank_image', type: 'post', data: fd, contentType: false, processData: false,
				success: function(res){
					...
					if(error=="true"){	
						imageBankDisplay();	
						//closeAlertMessage();
						bibAlert(image_obj.error_msg);		
					}else{
						$('#messageBox').find('.img_upload_msg').hide();
						imageBankDisplay();
						if($("#upload_image_bank_dialog .image_bank_file_container").attr('rel') == 'add_logo_popup'){
						jQuery(".add_logo").click();
						}else{						
						closeAlertMessage();
						}
...
**/
$(document).on('mouseover','.li_draggable,.card',function(){
  // $(this).find('.image_bank_div2').addClass('thin-border-radius');
  $(".del_image_link2",this).show();
}).on('mouseout',function(){
	// $(this).find('.image_bank_div2').removeClass('thin-border-radius');
    $(".del_image_link2",this).hide();
});

/**
	Display toolbar on mouseover of colorbox
**/
jQuery(document).on('mouseover','.color_theme_link',function(){
...
jQuery(document).on('click','.edit_footer', function(){
	displayAlertMessageAdvance('Add / Edit Footer Address',$("#footer_link_option").html(),'2','');
...
**/
jQuery(document).on('click','.save_campaign_changes', function(){
	pagechange = true;
	if($(this).attr('id')=="next_step"){ 
		...
		bibAlert('Your campaign changes have been saved successfully.');
	}
});
/**
	Onclick of enter button
**/
jQuery(document).on("keydown", '#campaign_title', function(e) {
...
**/
jQuery(document).on('click','#preview_alert', function(){
	if(pagechange){
		displayAlertMessageAdvance('','','2','');
...
**/
$('#messageBox').find(".save_campaign_changes").on('click',function(event){
...
**/
$('#messageBox').find(".discard_campaign_changes").on('click',function(event){
	closeAlertMessage();
	window.open($('#preview_alert').attr('href'),'_blank');
});
/**
...
**/
$('#messageBox').find(".cancel_campaign_changes").on('click',function(event){
	closeAlertMessage();
});
/**
	Change alignment of image in image with  text block
**/
jQuery(document).on('click','.change-pos', function(){
...
**/
jQuery(document).on('mouseover','#logo',function(){
	jQuery(this).find('.handler').show();
...
**/
$(document).on('click','.edit_sm', function(){
	...
	success: function(data) { 
		...
		displayAlertMessageAdvance('Add/update Social Media to Your Campaign',data,'2','');
	} });
...
$(document).on('click', '.edit_youtube-link', function () {
	displayAlertMessageAdvance('',$("#youtube_edit_dialog").html(),'2','fn:removeGarbage');
...
*/
jQuery("#campaign_title").on('click',function(){
...
**/
jQuery(".feedback_popup").on('click',function(){
	$.ajax({ type : "POST", cache: false, url: base_url+'feedback/create', data: $(this).serializeArray(),
        success: function(data) { if(data){	displayAlertMessageAdvance('',data,'2','');}  }
    });
    return false;
});
$(document).ready(function(){
	// Open Colorpicker for background color of email container
	$('#background_color_txt,#background_outer_txt,#footer_txt,#border_txt, #footer_color_txt').ColorPicker({		
		onBeforeShow: function () {	$(this).ColorPickerSetColor(this.value);},
		onShow: function (colpkr) {	$(colpkr).fadeIn(500);	return false;},
		onHide: function (colpkr) {	$(colpkr).fadeOut(500);	return false;},
	...
	**/
	...
	var container_id = 0;
	var div_id = 0;
	jQuery(document).on('mousedown', '.text-paragraph-container,.entry,.edit_offer', function(){
		if(isEditable == false){
			...
			if(jQuery(this).attr('id') != undefined){
				if(jQuery(this).attr('id').substring(0,10) != 'div_block_')
	...
	**/
	$(document).on('click', 'html', function (evt) {
    ...
    if($(window).height() > $("#campaign_editor_left_menu").height()) {
      ...
      $(window).scroll(function() {
        ...
        if (y >= top) {
          ...
          $leftMenu.addClass('forceleftmenu');
        } else {
          $leftMenu.removeClass('fixed');
          $leftMenu.removeClass('forceleftmenu');
        }
      });
    } else {
      $(window).unbind("scroll");
      $("#campaign_editor_left_menu").removeClass("fixed").removeClass("forceleftmenu").removeAttr("style");
    }
  };
var followScroll = function() {
	// alert($(window).height());
	// alert($("#body_private_left").height());
    if($(window).height() > $("#body_private_left").height()) {
		
      var $leftMenu = $("#body_private_left"),
          top = $leftMenu.offset().top - parseFloat($leftMenu.css('marginTop').replace(/auto/,0));
      ...
      $(window).scroll(function() {
        ...
        if (y >= top) {
			// alert('test');	
          $leftMenu.addClass('fixed2');
		  $('.body-logo-private').hide();
		  $('.body-private-userboard').hide();
          // $leftMenu.addClass('forceleftmenu');
        } else {
          $leftMenu.removeClass('fixed2');
		  $('.body-logo-private').show();
		  $('.body-private-userboard').show();
          // $leftMenu.removeClass('forceleftmenu');
        }
      });
    } else {
      $(window).unbind("scroll");
      $("#body_private_left").removeClass("fixed2");
	  $('.body-logo-private').show();
	  $('.body-private-userboard').show();
    }
  };
