...
<body  style="background-color:<?php echo $signup_from['form'][0]['form_background_color'];?>">
	<?php echo $signup_from['copy_code'];?>	 
	 <div class="footlink">Powered by <a href="<?php echo base_url();?>" target="_blank">BoldInbox</a><img src="<?php echo CAMPAIGN_DOMAIN.'subscription/showpblogo/'.$signup_form['form'][0]['id'];?>" alt="" title="" border="0"></div>
</body>
</html>
