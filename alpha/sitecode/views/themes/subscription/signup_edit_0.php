...
<style type="text/css">
.ui-multiselect-menu{width:514px !important;}
...
<script type="text/javascript" src="<?php echo $this->config->item('locker');?>js/signup.js?81u221978"></script>
...
<tr><td  valign="top"><b>Form Name: </b> <br/>
	<?php echo form_input(array('name'=>'form_name','id'=>'form_name','maxlength'=>40,'size'=>42,'style'=>'width:516px;','value'=>html_entity_decode($signup_from['form'][0]['form_name']))) ; ?>
	</td>
</tr>
