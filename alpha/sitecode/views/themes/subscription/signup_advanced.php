<table width="100%" cellspacing="0" cellpadding="3">
	...
	<tr><td width="50%">
		...
		<span class="autotresponder_list_div" style="margin-left:5px;"><a href="javascript:void(0);" id="btn_add_other_eml" class="edit-interval">Add New</a></span>
                  <span><a href="javascript:void(0);" onclick="javascript: updateFromEmailDpd();" id="btn_refresh" style="margin-left:5px;"><img src="<?php echo $this->config->item('locker');?>images/boldinbox_sync.png" height="14" alt="Refresh" align="absmiddle" /></a></span>		
		</td></tr>
	...
	<tr><th colspan="2">
	<!-- Temp added -->
	<input type="hidden" id="singup_thank_you_message_url" value="http://" name="singup_thank_you_message_url">
	<input type="hidden" id="confirmation_thanks_you_message_url" value="http://" name="confirmation_thanks_you_message_url">
	<input type="hidden" id="form_language" value="en" name="form_language">
	<!-- Temp added -->
