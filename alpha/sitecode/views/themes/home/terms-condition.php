<div class = 'body-public'>
	<div class = 'body-box-support'>		
		<div class = 'body-form-text2'>Policies & Terms</div>
		<div class = 'body-form-desc'><b>Important: Please go through all the policies and terms carefully before you start using our services. By Signing Up to our services you are bound to agree to all our Policies & Terms of Use. Make sure to not use the website further anymore, if you do not agree to our terms.</b></div>
		<div class="support_category_block">
		<ul>
			<li><a class = 'active'>Privacy Policy</a>
					...
					<li>
						<div class="support_topic_desc">
							<div class = 'body-form-desc'>
								...
								<br /><br />
								You can feel free to write to us at support@BoldInbox.com should you have any queries regarding our Privacy Policy.
							</div>
						</div>					
					</li>
				</ul>	
			...
			<li><a class = 'active' name = 'anti-spam-policy'>Anti Spam Policy</a>
				<ul class = 'support_topics'>
					<li>
						<div class="support_topic_desc">
							<div class = 'body-form-desc'>
			...
			<li><a class = 'active'>Terms of Services & Use</a>
				<ul class = 'support_topics'>
					<li><a>Email Promotion Services:</a>
						<div class="support_topic_desc">
							<div class = 'body-form-desc'>I agree that, all email lists (List of Subscribers) I will be sending to using your services must be permission-based subscriptions. It  will never be acceptable and allowed to send promotional emails to any rented, purchased or third party list of subscribers. 
							<br /><br />
							BoldInbox reserves the right to suspend sending on my account if found to be violating the terms of use of services.
							</div>
						</div>
					</li>
					<li><a>Account Credentials, Payment & Security:</a>
						<div class="support_topic_desc">
							<div class = 'body-form-desc'>I agree that, the confidentiality to keep my account credentials secure is completely my responsibility. I will be whole solely responsible for all the activities under my account.
							<br /><br />
					...
					<li><a>Essentials:</a>
						<div class="support_topic_desc">
							<div class = 'body-form-desc'>I agree that, BoldInbox will automatically place an "Unsubscribe" & "Report SPAM" Links in all the email promotions I will be sending using your services.BoldInbox will also add all the required Email Headers in all the email promotions.<br /><br /> All my email promotions must have a valid physical address mentioned at the bottom (footer) of the email, BoldInbox will not release any email with missing footer information. 
							<br /><br />
					...
					<li><a>Prohibited Use:</a>
						<div class="support_topic_desc">
							<div class = 'body-form-desc'>BoldInbox prohibits the use of its services by anyone who violates the Terms of Use and / or CAN SPAM ACT. You are not allowed to send email promotions containing contents related to children under 18 years of age, dating / escort services, pornography, affiliate marketing, pyramid schemes, MLM, "Get Rich Quick", Forex, gambling, weight loss supplements or illegal goods and services.  
							<br /><br />
					...
					<li><a>Revisions & Modifications:</a>
						<div class="support_topic_desc">
							<div class = 'body-form-desc'>BoldInbox reserves the right to make any changes to any information posted on the entire website without in prior notice the users. 
							<br /><br />
					...
					<li><a>Account Suspension & Refunds:</a>
						<div class="support_topic_desc">
							<div class = 'body-form-desc'>BoldInbox reserves the right to Suspend / Terminate any account without any notice. If you wish to get your account cancelled, you may do so by writing an email to support@boldInbox.com. BoldInbox will not make any refunds for any remaining period within your subscription cycle.
							<br /><br />
							...
							<br /><br />
							However BoldInbox, may at its sole discretion, offer a pro-rata refund based on the number of emails actually sent to at $0.003 per email for a sum total not exceeding the total payment made.
							</div>
						</div>
					</li>
					<li><a>Limitation of Liability:</a>
						<div class="support_topic_desc">
							<div class = 'body-form-desc'>In no event shall BoldInbox be responsible and liable for any losses or damages (direct or indirect, special, incidental or consequential) in terms of data or other economic harm to the business due to non-performance, any error, computer virus, service interruption, delay, organizational issues, company staff or failure to understand the use of service.
							</div>
						</div>
					</li>
					<li><a>Intellectual Property:</a>
						<div class="support_topic_desc">
							<div class = 'body-form-desc'>
					...
					<li><a>Indemnification:</a>
						<div class="support_topic_desc">
							<div class = 'body-form-desc'>I agree to defend, indemnify and hold harmless BoldInbox and our business partners, third-party suppliers and providers, licensors, officers, directors, employees, distributors and agents against any damages, losses, liabilities and expenses due to any action that arises from any alleged breach of this contract or relates to your use of BoldInbox services.
							</div>
						</div>
					</li>				
				</ul>
