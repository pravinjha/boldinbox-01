    ...
    <div class="mobile-nav-wrapper">
      <div class="mobile-menu-inner">
         <ul class="mobile-menu">
			...
			?>
			<li class="has-sub"><a href = 'javascript:void(0);' <?php if($this->router->fetch_class() == 'promotions') echo 'class="link_active"';?>>Campaigns<i class="sub-icon fa fa-angle-down"></i></a>
			<ul class="sub-menu">
				<li><a href = '<?php echo site_url('promotions');?>' <?php if($this->router->fetch_class() == 'promotions' and $this->router->fetch_method() == 'index') echo 'class="sub_link_active"';?>>Campaigns List</a></li>
				<li><a href = '<?php echo site_url('promotions/layouts');?>' <?php if($this->router->fetch_method() == 'layouts') echo 'class="sub_link_active"';?>>Campaign Builder</a></li>
				<li><a href = '<?php echo site_url('promotions/plain_text');?>' <?php if($this->router->fetch_method() == 'plain_text') echo 'class="sub_link_active"';?>>Text Email</a></li>			
				<li><a href = '<?php echo site_url('promotions/html_code');?>' <?php if($this->router->fetch_method() == 'html_code') echo 'class="sub_link_active"';?>>Paste HTML Code</a></li>
				<li><a href = '<?php echo site_url('promotions/url_import');?>' <?php if($this->router->fetch_method() == 'url_import') echo 'class="sub_link_active"';?>>Generate from URL</a></li>		
				<li><a href = '<?php echo site_url('promotions/zip_import');?>' <?php if($this->router->fetch_method() == 'zip_import') echo 'class="sub_link_active"';?>>Generate from Zip File</a></li>
			  </ul>
		  </li>
		  <?php
		  }
	  ...
	  <?php 
		...
		?>				
			<li class="has-sub"><a href = 'javascript:void(0);' <?php if($this->router->fetch_class() == 'contacts') echo 'class="link_active"';?>>Contacts<i class="sub-icon fa fa-angle-down"></i></a>
				<ul class="sub-menu">
					<li><a href='<?php  echo  site_url("contacts"); ?>' <?php if($this->router->fetch_class() == 'contacts' and $this->router->fetch_method() == 'index') echo 'class="sub_link_active"';?>>Email Contact List</a></li>
						<?php if($this->router->fetch_class() == 'contacts'){?>
						<li><a onclick="createList();" href="javascript:void(0);" >Create a New List</a></li>
						<?php }?>
						<li><a href='<?php  echo  site_url("contacts/add_contacts"); ?>' <?php if($this->router->fetch_class() == 'contacts' and $this->router->fetch_method() == 'add_contacts') echo 'class="sub_link_active"';?>>Add New Contacts</a></li>
			  </ul>
			</li>
			<?php 
				} 
			?>
		  	<?php if($this->session->userdata('member_staff') == 0 or $this->session->userdata('manage_stats') > 0){ ?>
				<li><a href = '<?php echo site_url('stats/display');?>' <?php if($this->router->fetch_class() == 'stats') echo 'class="link_active"';?>>Campaign Stats</a></li>
			<?php } ?>
			
          	<?php if($this->session->userdata('member_staff') == 0 or $this->session->userdata('manage_signupforms') > 0){?>
				<li class="has-sub"><a href = 'javascript:void(0);' <?php if($this->router->fetch_class() == 'subscription') echo 'class="link_active"';?>>Signup-form<i class="sub-icon fa fa-angle-down"></i></a>				
				<ul class="sub-menu">
				<li><a href='<?php  echo  site_url("subscription"); ?>' <?php if($this->router->fetch_class() == 'subscription' and $this->router->fetch_method() == 'index') echo 'class="sub_link_active"';?>>Signup Form List</a></li>
				<li><a href='<?php  echo  site_url("subscription/create"); ?>' <?php if($this->router->fetch_class() == 'subscription' and $this->router->fetch_method() == 'edit') echo 'class="sub_link_active"';?>>Create Signup Form</a></li>
				</ul>
			</li>
			<?php					 
			} 
			?>
          	<?php					
				if($this->router->fetch_class() == 'account' or $this->router->fetch_class() == 'user' or $this->router->fetch_class() == 'change_package'){$styl = 'class="link_active"';}else{$styl='';}
			?> 
			<li class="has-sub"><a href = 'javascript:void(0);'   <?php echo $styl;?>>Settings<i class="sub-icon fa fa-angle-down"></i></a>				 			
				<ul class="sub-menu">
					<li><a href='<?php  echo  site_url("account/index"); ?>' <?php if($this->router->fetch_class() == 'account' and $this->router->fetch_method() == 'index') echo 'class="sub_link_active"';?>>Account</a></li>
					<li><a href='<?php  echo  site_url("change_package"); ?>' <?php if($this->router->fetch_class() == 'change_package' and $this->router->fetch_method() == 'index') echo 'class="sub_link_active"';?>>Package</a></li>
					<li><a href='<?php  echo  site_url("user/change_password"); ?>' <?php if($this->router->fetch_class() == 'user' and $this->router->fetch_method() == 'change_password') echo 'class="sub_link_active"';?>>Change Password</a></li>
				</ul>
			</li>
			<li class = 'last_link'><a href = '<?php echo site_url('home/support');?>'  target="_blank">Support</a></li>
        ...
        <div class="header-wrap">
         ...
         <div class="header-nav">
			  ...
			  <?php  	
				if($this->session->userdata('member_staff') == 0 or $this->session->userdata('manage_campaigns') > 0){									
				?>
                <li class="menu-item-has-children"><a href = '<?php echo site_url('promotions');?>' <?php if($this->router->fetch_class() == 'promotions') echo 'class="link_active"';?>>Campaigns <i class="sub-icon fa fa-angle-down"></i></a>
					<ul class="sub-menu">
						<li><a href = '<?php echo site_url('promotions');?>' <?php if($this->router->fetch_class() == 'promotions' and $this->router->fetch_method() == 'index') echo 'class="sub_link_active"';?>>Campaigns List</a></li>
						<li><a href = '<?php echo site_url('promotions/layouts');?>' <?php if($this->router->fetch_method() == 'layouts') echo 'class="sub_link_active"';?>>Campaign Builder</a></li>
						<li><a href = '<?php echo site_url('promotions/plain_text');?>' <?php if($this->router->fetch_method() == 'plain_text') echo 'class="sub_link_active"';?>>Text Email</a></li>			
			  ...
			  ?>
				...
				if($this->session->userdata('member_staff') == 0 or $this->session->userdata('manage_contacts') > 0){					
				?>				
          		<li class="menu-item-has-children"><a href = '<?php echo site_url('contacts');?>' <?php if($this->router->fetch_class() == 'contacts') echo 'class="link_active"';?>>Contacts <i class="sub-icon fa fa-angle-down"></i></a>
					<ul class="sub-menu">
						<li><a href='<?php  echo  site_url("contacts"); ?>' <?php if($this->router->fetch_class() == 'contacts' and $this->router->fetch_method() == 'index') echo 'class="sub_link_active"';?>>Email Contact List</a></li>
						<?php if($this->router->fetch_class() == 'contacts'){?>
						<li><a onclick="createList();" href="javascript:void(0);" >Create a New List</a></li>
				...
				<?php } ?>
          		<?php if($this->session->userdata('member_staff') == 0 or $this->session->userdata('manage_signupforms') > 0){ ?>	
					<li class="menu-item-has-children"><a href = '<?php echo site_url('subscription');?>' <?php if($this->router->fetch_class() == 'subscription') echo 'class="link_active"';?>>Signup-form <i class="sub-icon fa fa-angle-down"></i></a>				
					<ul class="sub-menu">
                    <li><a href='<?php  echo  site_url("subscription"); ?>' <?php if($this->router->fetch_class() == 'subscription' and $this->router->fetch_method() == 'index') echo 'class="sub_link_active"';?>>Signup Form List</a></li>
				<li><a href='<?php  echo  site_url("subscription/create"); ?>' <?php if($this->router->fetch_class() == 'subscription' and $this->router->fetch_method() == 'edit') echo 'class="sub_link_active"';?>>Create Signup Form</a></li>
					</ul>
				...
				<li><a href = '<?php echo site_url('home/support');?>' target="_blank">Support</a></li>
