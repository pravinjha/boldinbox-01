...
echo form_open('bandook/template_category/category_edit/'.$category['red_theme_id'], array('id' => 'frmCategoryEdit'));
...
echo '&nbsp;';
echo form_button(array('name'=>'btnCancel','class'=>'inputbuttons', 'value'=>'Cancel','content'=>'Cancel','onclick'=>"window.location.href='".base_url().'bandook/template_category/template_category_list'."'"));
echo "</td></tr>";
