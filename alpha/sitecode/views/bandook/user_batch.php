        ...
        foreach ($subscriber_data as $sd => $value) {
            ...
            <tr>
                ...
                <td width="28%">
                        ...
                        <a style="border:1px solid #ccc;background:#ebebeb; color:#333;padding:2px 5px;" href="<?php echo  site_url('bandook/users_manage/user_cron_batch/'.$value['dv_id'].'/'.$value['rc_member_id']);?>" style="color:red;">
