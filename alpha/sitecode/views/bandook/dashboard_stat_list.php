...
<table class="tbl_listing" width="100%"> 
	<thead> 
		<tr> 
			<td width="15%">Total Users</td><td><a href="<?php echo base_url() ?>bandook/users_manage/users_list"><?php echo $total_users_count ;?></a></td>
		</tr>
		<tr>	
			<td width="15%">Paid users</td><td><a href="<?php echo base_url() ?>bandook/users_manage/paid_users"><?php echo $paid_users_count ;?></a></td>		
		</tr>
		<tr>	
		...
		<tr><td width="15%">Users Requiring Upgrades</td>
			<td><a href="<?php echo base_url() ?>bandook/users_manage/upgrade_users">View<?php echo $user_upgrade_count ;?></a></td>		
		</tr> 
		<tr> 
		...
		<tr> 
			...
			<td><a href="<?php echo base_url() ?>bandook/campaign/approval"><?php echo $campaign_approval_count ;?></a></td>
		...
		<tr> 
			...
			<td>
				<a href="<?php echo base_url() ?>bandook/dashboard_stat/sent_campaign"><?php echo $sent_campaign_count ;?></a>
			</td>
		...
		<tr> 
			...
			<td>
				<a href="<?php echo  site_url("bandook/activity_log");?>">Activity Log</a>
			</td>
		...
		<tr> 
			...
			<td>
				<a href="<?php echo  site_url("bandook/campaign");?>">Campaign Approval</a>
			</td>
