...
<div class="form">
	<?php
	echo form_open('bandook/blog_listing_post/post_create/'.$cat_id, array('id' => 'frmPostCreate'));
	...
	echo '&nbsp;';
	echo form_button(array('name'=>'btnCancel','class'=>'inputbuttons', 'value'=>'Cancel','content'=>'Cancel','onclick'=>"window.location.href='".base_url().'bandook/Blog_listing_post/post_list/'.$category['cat_id']."'"));
	echo "</td></tr>";
