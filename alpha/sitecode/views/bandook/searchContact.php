...
<link rel="stylesheet" type="text/css" href="<?php echo $this->config->item('locker');?>js/fancybox/jquery.fancybox-1.3.4.css?v=6-20-13" media="screen" />
...
<script type="text/javascript">
	...
	function srchnow(){
		...
		jQuery.ajax({
		  url: "<?php echo base_url() ?>bandook/contacts_segmentation/srchcontactnow/",
		  type:"POST",
		  data: "e="+c,
	...
	function unsubIt(cid){
		var c = $('#srchContact').val();
		jQuery.ajax({
		  url: "<?php echo base_url() ?>bandook/contacts_segmentation/unsubit/",
		  type:"POST",
		  data: "e="+c+"&cid="+cid,
		  success: function(data) {
			$('.search_contacts').html(data);
    ...
    function unsuball(){
		var c = $('#srchContact').val();
		jQuery.ajax({
		  url: "<?php echo base_url() ?>bandook/contacts_segmentation/unsuball/",
		  type:"POST",
		  data: "e="+c,
		  success: function(data) {
			$('.search_contacts').html(data);
...
var locker="<?php echo $this->config->item('locker');?>";
var memid="<?php echo $extra['member_id'];?>";
</script>
<script type="text/javascript" src="<?php echo $this->config->item('locker'); ?>js/contacts_add_admin.js?v=6-20-13"></script>
<!--[body]-->
    ...
    <div class="container">
      ...
      <div class="form-fields">
        <div class="import_contact subscriber_menus">
          ...
          <?php echo form_open_multipart('bandook/contacts_segmentation/addDNMSubmit/', array('id' => 'form_dnm_import','name'=>'form_dnm_import','class'=>"form-website")); ?>
            <div>
