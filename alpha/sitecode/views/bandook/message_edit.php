<div class="tblheading">Modify Message</div>
<div id="messages">
<?php
...
echo form_open('bandook/manage_messages/message_edit/'.$message_detail['message_id'], array('id' => 'frmMsgEdit'));
...
echo '&nbsp;';
echo form_button(array('name'=>'btnCancel','class'=>'inputbuttons', 'value'=>'Cancel','content'=>'Cancel','onclick'=>"window.location.href='".base_url().'bandook/manage_messages/'."'"));
echo "</td></tr>";
