...
<script>
	...
	jQuery('.class_verify').live('click',function(){
		...
		if ($(this).attr('checked'))
			is_verified = 1;
		jQuery.ajax({
				  url: "<?php echo base_url() ?>bandook/autoresponders/update_aresponder/",
				  type:"POST",
...
<form name="Src_frm" id="Src_frm" method="post" action="<?php echo base_url().'bandook/autoresponders/index/'.$mode;?>">
	<table border="0" cellspacing="0" cellpadding="0" class="tbl_forms">
		<tr>
			...
			<td align="right" style="text-align:right;"><a href="<?php echo  site_url("bandook/autoresponders/index/$reverseMode");?>"><?php echo  ucfirst($reverseMode);?> List</a></td>
		</tr>
		<tr>
...
if(count($autoresponders)) {
	...
	<tr>
		<td width="20%">
			<a href="<?php echo  site_url("bandook/users_manage/users_list/".$thisAutoresponder['member_username']); ?>"><?php echo $thisAutoresponder['member_username'];  ?></a>
		</td>
		<td width="70%">		 
