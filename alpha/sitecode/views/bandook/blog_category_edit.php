...
echo form_open('bandook/blog_listing_category/category_edit/'.$category['id'], array('id' => 'frmCategoryEdit'));
...
echo '&nbsp;';
echo form_button(array('name'=>'btnCancel','class'=>'inputbuttons', 'value'=>'Cancel','content'=>'Cancel','onclick'=>"window.location.href='".base_url().'index.php/bandook/blog_listing_category/category_list'."'"));
echo "</td></tr>";
