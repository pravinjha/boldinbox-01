...
class Template_category extends CI_Controller
{
	...
	{ 
		...
		$config['base_url']=base_url().'bandook/template_category/template_category_list';
		...
		$this->load->view('bandook/template_category_list',array('category'=>$category_data_array,'paging_links'=>$paging_links,'messages' =>$messages));
	...
	function category_edit($id)
	{
		...
		if($this->input->post('action')=='submit')
		{
			...
			if($this->form_validation->run()) {
				...
				else
				{
					...
					redirect('bandook/template_category/template_category_list');
				}
			}
		...
		$this->load->view('bandook/template_category_edit',array('category'=>$category_data_array,'messages' =>$messages));
		$this->load->view('bandook/footer');
	}
	...
	function category_create()
	{
		...
		$this->load->view('bandook/template_category_create',array('category'=>$category_data_array,'messages' =>$messages));
		$this->load->view('bandook/footer');
	}
}
?>