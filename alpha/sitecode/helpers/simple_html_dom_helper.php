	...
	foreach($html_strp->find('table.container-div') as $e){
		...
		if('container-div preheader'==$e->getAttribute("class")){
			...
			*/
			...
			$style .=" width: 100%; border-top-color:".$campaign_body_bg_color.";border-bottom-color:".$campaign_body_bg_color."; border-top-style: solid;  border-bottom-style: solid;";
			$style .="border-left-color:".$campaign_body_bg_color."; border-left-style: solid;border-left-width: 20px;border-right-color:".$campaign_body_bg_color."; border-right-style: solid;border-right-width: 20px;";		
			if($i==1){
