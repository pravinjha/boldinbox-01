...
//echo $to."<br/>==================<br/>".$sender."<br/>==================<br/>".$sender_name."<br/>==================<br/>".$subject."<br/>==================<br/>".$message."<br/>==================<br/>".$text_message;
	...
	$mail->SMTPDebug = 0;  // debugging: 1 = errors and messages, 2 = messages only
	$mail->SMTPAuth = true;  // authentication enabled
	$arrSmtpDetail = getArrSMTP('pmta3-pool-1');
		$mail->Host = $arrSmtpDetail[0];
		$mail->Hostname = $arrSmtpDetail[0];
		$mail->Username = $arrSmtpDetail[1]; 
		$mail->Password = $arrSmtpDetail[2];
...
function bib_temp($to, $sender="",$sender_name="", $subject="",$message="",$text_message="", $vmta='boldinbox.com'){
//echo $to."<br/>==================<br/>".$sender."<br/>==================<br/>".$sender_name."<br/>==================<br/>".$subject."<br/>==================<br/>".$message."<br/>==================<br/>".$text_message;
	...
	$mail->SMTPAuth = true;  // authentication enabled
	$arrSmtpDetail = getArrSMTP('sendgrid');
	//print_r($arrSmtpDetail);
	...
	$mail->AddReplyTo('sumit@boldinbox.com', 'BoldInbox Support');	
	$mail->FromName = 'BoldInbox';
	$mail->From = 'gototravels@trupiz.com';  
	$mail->Subject = $subject;	
...
try {
    ...
    $mail->SMTPAuth = true;
    //array('','apikey','', '587', 'bounce@bibesp.com','boldinbox') 
    $mail->Host = 'smtp.sendgrid.net';  // Specify main and backup SMTP servers
                                   // Enable SMTP authentication
    $mail->Username = 'apikey';                 // SMTP username
    $mail->Password = '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';                           // SMTP password
    //$mail->SMTPSecure = 'tls';                            // Enable TLS encryption, `ssl` also accepted
    $mail->Port = 2525;                                    // TCP port to connect to

    //Recipients
    $mail->setFrom('info@boldinbox.com', 'BoldInbox');
    $mail->addAddress('peejha@yahoo.com', 'Joe User');     // Add a recipient
    $mail->addAddress('pravinjha@gmail.com');               // Name is optional
...
require_once("phpmailer/class.phpmailer.php");
$mail = new PHPMailer();
$arrSmtpDetail = getArrSMTP('amazon');
print_r($arrSmtpDetail);
    ...
    $mail->Host = 'email-smtp.us-west-2.amazonaws.com';//$arrSmtpDetail[0];
	//$mail->Hostname = $arrSmtpDetail[0];
	$mail->Username = 'AKIAJJ553AB6AC4L545Q';//$arrSmtpDetail[1]; 
	$mail->Password = 'AhGW7PP+FitF/EnbPBdwIu9KRYp+DIMdejiHQccXO9SQ';//$arrSmtpDetail[2];
	//$mail->SMTPSecure = 'tls';
	$mail->Port = 2587;//$arrSmtpDetail[3];
	//$mail->AddCustomHeader('Sender: '.$arrSmtpDetail[4]);	
	//$mail->Sender	= $arrSmtpDetail[4];
                                     // TCP port to connect to

    //Recipients
    $mail->setFrom('boldinbox@gmail.com', 'BoldInbox');
    $mail->addAddress('pravin@boldinbox.com', 'Joe User');     // Add a recipient
    $mail->addAddress('boldinbox@gmail.com');               // Name is optional
...
$mail->IsHTML(true);
$mail->Username = "boldinbox@gmail.com";
$mail->Password = "AllSet@2017";
$mail->SetFrom("boldinbox@gmail.com");
$mail->Subject = "Test";
$mail->Body = "hello";
$mail->AddAddress("pravinjha@gmail.com");
*/
