  ...
  function addCustomRow(type,friendlyName){
    ...
    var row = [
      '<div id="custom',index,'" class="add-sign-up-field custom active" name="field_custom',index,'">',
        ...
        row.push('<i class="icon icon-trash delete_custom">Del</i>');
...
function delCustom(custom_field_val){	alert(custom_field_val);
...
var removeCustomField = function($popupLocation,$removeTarget) {
		...
		alert(custom_field_val);
		bibConfirm("This will permanently remove this field from your sign-up form. Are you sure?","delCustom("'+custom_field_val+'")' )
