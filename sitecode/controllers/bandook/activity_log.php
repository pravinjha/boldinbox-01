...
class Activity_Log extends CI_Controller
{
	...
	**/
	function display($start=0){
		...
		$config['base_url']=base_url().'bandook/activity_log/display';
		...
		$this->load->view('bandook/header',array('title'=>'Manage Activity Log','logo_link'=>$logo_link));
		$this->load->view('bandook/activity_log_list',array('activity_logs'=>$activity_data_array,'paging_links'=>$paging_links,'messages' =>$messages,'contacts'=>$contacts_array,'shorten_url'=>$shorten_url));
