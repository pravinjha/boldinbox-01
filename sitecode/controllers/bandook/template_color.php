...
class Template_color extends CI_Controller
{
	function __construct()
	{
		...
		$this->load->model('bandook/TemplateColor_Model');
	...
	function template_color_list($start=0)
	{
		...
		$config['base_url']=base_url().'bandook/template_color/template_color_list';
		...
		$this->load->view('bandook/template_color_list',array('colors'=>$color_data_array,'paging_links'=>$paging_links,'messages' =>$messages));
	...
	function color_create()
	{
		...
		$this->load->view('bandook/template_color_create',array('color'=>$color_data_array,'messages' =>$messages));
		$this->load->view('bandook/footer');
	}
}
?>