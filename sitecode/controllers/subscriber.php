		...
		*/
		...
		if(count($subscriber_data['subscribers'])){
			...
			<tr class='contacts_change'>
							<th width=\"4%\"></th>
							<th width=\"52%\" class='contact_change_td' ><a href='javascript:void(0);' onclick='order_by(\"subscriber_email_address\")'>Email Address</a></th>
			...
			foreach ($subscriber_data['subscribers'] as $subscriber){
				...
				$contact_list.="<div class = '$alternate_class'>
						<div class = 'cl_1'><input  class='check-boxalign' type='checkbox'  value='".$subscriber['subscriber_id']."' name='subscriber_id[]' id='subscriber_id' ".$checked.$disabeld."></div>
						<div class = 'cl_2'><a title='".$subscriber['subscriber_email_address']."' href='".site_url('subscriber/detail/'.$subscriber['subscriber_id'])."'>".substr($subscriber['subscriber_email_address'],0,50)."</a></div>
						<div class = 'cl_3'>".substr(stripslashes($subscriber['subscriber_first_name']),0,25)." &nbsp;</div>
						<div class = 'cl_4'>
							<a href='".site_url('subscriber/detail/'.$subscriber['subscriber_id'])."'><img src = '". $this->config->item('locker')."images/icons/view_edit.png' alt = 'Edit this contact' title = 'Edit this contact' width = '20' /></a>
							<a href='".site_url('subscriber/subscriber_delete/'.$subscriber['subscription_id'].'/'.$subscriber['subscriber_id'])."' class='fancybox_delete btn cancel' name='".$subscriber['subscriber_id']."'><img src = '". $this->config->item('locker')."images/icons/trash_can.png' width = '20' alt = 'Delete this contact' title = 'Delete this contact' /></a>
						</div>
					</div>";					
			}
            ...
            No Records Found. <br /><br /><br /><a class="button grey2 large" href="'. site_url("bib_add_contacts").'"> + Add New Contacts</a>
          </div></td></tr>'; 
			}else{ 
			$contact_list.='<tr class="contacts_change">
			<td colspan="4" valign = "top" style = "padding:10px;font-size:14px;color:#666;text-align:center;"><div style="height: 400px">
