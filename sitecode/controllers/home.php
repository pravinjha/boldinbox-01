...
Thanks,
The BoldInbox Team';
		//bib_transactional('test-aytl7txcr@srv1.mail-tester.com', 'sumit@boldinbox.com', 'BoldInbox Support', 'Confirm your new "From Email"',nl2br($msg),$msg);
		//bib_transactional('pravinjha@gmail.com', 'sumit@boldinbox.com', 'BoldInbox Support', 'Confirm your new "From Email"',nl2br($msg),$msg);
		bib_transactional('sumit@boldinbox.com', 'info@proddy.in', 'BoldInbox Support', 'Confirm your new "From Email"',nl2br($msg),$msg);
	...
	function info(){
		...
		$do_not_mail_list_arr=explode(",",str_replace(array("\n"," "),array('',''),$confg_arr['do_not_mail_list']));
		
		echo "<pre>";
		print_r($do_not_mail_list_arr);
	}
}
?>