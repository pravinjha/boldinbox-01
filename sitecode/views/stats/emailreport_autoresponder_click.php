...
<div id="body-dashborad" class="nobackground">
  <div class="container">
    ...
    <div class="left-menu contacts stats">
      <div class="editing-theme-box <?php echo $current_tab == 'send_email' ? 'active' : '';?>" onclick="window.location='<?php echo  site_url("userboard/emailreport_autoresponder/view/sent/".$campaign_id);?>'">
                  ...
                  <tr>
                    ...
                    <td>
                      <?php if($campaign_data['is_restore']==0){?>
						<a class="btn cancel" href="<?php echo  site_url("userboard/emailreport_autoresponder/view/view_subscriber_click/".$click['campaign_id']."/".$scheduled_id."/0/".$click['tiny_url']);?>"><?php echo $click['cnt']; ?> Clicks</a>
                      <?php }else{ ?>
