...
var handler_image4="<div class='handler_img'><ul><li><a  class='option_image-link'><img src='<?php echo base_url() ?>locker/images/icons/add_link.png' title='Add Link'/></a></li><li><a  class='option_image-caption' ><img src='<?php echo base_url() ?>locker/images/icons/caption.png' title='Add Caption'/></a></li><li><a  style='margin:0px' class='close-clone-link'><img src='<?php echo base_url() ?>locker/images/icons/delete.png' title='Delete'/></a></li></ul></div><div class='handler_img_width_height'></div>";	//4 images  handler
...
function saveImageGroupOption(img_count){	
	...
	if(img_count==1){
		...
		$('.empty_block').removeClass('empty_block');
		jQuery("#"+top_div).after("<table width='100%' cellspacing='0' cellpadding='0' class='container-div' id='"+im+"'><tr><td  class='handler_div' align='center'><table  align='center' class='resize_table' cellpadding='0' cellspacing='0'><tr><td align='left' class='img_content' id='"+im+"_1' valign='top'><div class='position_div'><img src='<?php echo base_url() ?>locker/images/contentBuilderEmailContentDrop.jpg?v=1.0' class='image-container drop-image' alt='Campaign-Image' width='265' height='265'  name='1' border='0'/><div class='resize_div ' style='width: 265px; height: 265px;'><div  class='div_border'><span style='display:none;' class='drop_div_border'></span></div><div  class='highlight_on_image_hover'><span style='display:none;' class='drop_div_border'></span></div></div></div><div class=\"active_image_option\"><span class='img_link_span'><img src='<?php echo base_url() ?>locker/images/icons/add_link.png' width = '16' class='image_link' style='display:none;'/></span></div><div><span class='image_caption'></span></div></td></tr></table></td></tr></table>");
		jQuery("#"+top_div).remove();
		var handler_block=handler.replace('[colspan]','1');
		...
		var im='block_'+new Date().getTime();		
		$('.empty_block').removeClass('empty_block');
		jQuery("#"+top_div).after("<table width='100%' cellspacing='0' cellpadding='0' class='container-div' id='"+im+"'><tr><td  class='handler_div'><table  align='center' class='resize_table' cellspacing='0' cellpadding='0'><tr><td align='left' class='img_content' id='"+im+"_1' valign='top' ><div class='position_div'><img src='<?php echo base_url() ?>locker/images/contentBuilderEmailContentDrop.jpg?v=1.0' class='image-container drop-image' alt='Campaign-Image' width='265' height='265' name='1' border='0' /><div class='resize_div ' style='width: 265px; height: 265px; '><div  class='div_border'><span style='display:none;' class='drop_div_border'></span></div><div  class='highlight_on_image_hover'><span style='display:none;' class='drop_div_border'></span></div></div></div><div class=\"active_image_option\"><span class='img_link_span'><img src='<?php echo base_url() ?>locker/images/icons/add_link.png' class='image_link' style='display:none;'/></span></div><div><span class='image_caption'></span></div></td><td align='left' class='img_content' id='"+im+"_2' valign='top' ><div class='position_div'><img src='<?php echo base_url() ?>locker/images/contentBuilderEmailContentDrop.jpg?v=1.0' class='image-container drop-image' alt='Campaign-Image' border='0'  width='265' height='265'  name='1' /><div class='resize_div ' style='width: 265px; height: 265px;'><div class='div_border'><span style='display:none;' class='drop_div_border'></span></div><div  class='highlight_on_image_hover'><span style='display:none;' class='drop_div_border'></span></div></div></div><div class=\"active_image_option\"><span class='img_link_span'><img src='<?php echo base_url() ?>locker/images/icons/add_link.png' class='image_link' style='display:none;'/></span></div><div><span class='image_caption'></span></div></td></tr></table></td></tr></table>");
		jQuery("#"+top_div).remove();
...
function addSM(){
	...
	var sm = ['facebook', 'twitter', 'instagram', 'linkedin', 'youtube', 'google_plus', 'mailto', 'skype', 'website', 'rss', 'tumblr', 'flickr', 'pinterest']; 
...
$('#messageBox').find('.youtube_msg').html("Please wait...");
	...
	if(matches){
		...
		if(url!=""){
			...
			var getURL = "https://www.youtube.com/oembed?url=http://youtube.com/watch?v="+video_id+"&format=json";
			...
			if(Object.keys(file_get_contents(getURL)).length === 0){
				$('#messageBox').find('.youtube_msg').show();
...
function youtubeFeedCallback(json){
	...
	var img_src=json.thumbnail_url; 
	...
	$("#"+ybid).find('.youtube_image_caption').html(json.title);
...
jQuery(".header_link").live('click',function(){	
	displayAlertMessage('Add a Link to Header','','0',true,290,120,false,'');
	$( "#message" ).html( $("#header_link_option").html() ); 
        ...
        success: function(data) {
			if(data == 'ok'){
				if(jQuery(this).find('img').length==0){
					...
					$( "#message" ).html( $("#upload_image_bank_dialog").html() ); 					
					$('.uplaod_image_url').show();
				}
			}else{
				displayAlertMessage('','','0',true,350,175,false,'');
				$( "#message" ).html( $("#block_upload_image_bank_dialog").html() );				
			}
        }
    });
...
**/
$('#messageBox').find('#image_bank_file').live('change',function(){
$('#messageBox').find('.img_upload_msg').show();
