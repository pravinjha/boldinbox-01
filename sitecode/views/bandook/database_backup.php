<script type="text/javascript">
	function downloadDatabase(){
		var confirm_submit=confirm("Do you want to download BoldInbox database");
		if (confirm_submit)
		{
...
<?php
echo form_open('bandook/database_backup/', array('id' => 'frmDatabaseBackup','name'=>'frmDatabaseBackup','onsubmit'=>'downloadDatabase(); return false'));
