...
<script type="text/javascript">
	...
	function openIpr(){		
		...
		jQuery.ajax({
			url: "<?php echo base_url() ?>bandook/dashboard_stat/auto_ipr/",
			type:"POST",
			data:block_data,
...
<?php $ci =& get_instance(); ?>
<form name="Src_frm" id="Src_frm" method="post" action="<?php echo base_url().'bandook/dashboard_stat/sent_autoresponders';?>">
...
<table class="tbl_listing" width="100%"> 
	...
	<tr <?php echo $rowBGColor;?>>
		...
		<tr>
			...
			<td width="25%"><a class="fancybox" href="<?php echo  site_url('bandook/dashboard_stat/auto_ipr/'.$email['autoresponder_scheduled_id']);?>">IPR</a></td>
		</tr>
