...
<div style="text-align: right;"><a href="<?php echo base_url() ?>bandook/packages_manage/package_create"><strong>Create New Package</strong></a></div>
...
<tr>
	...
	<td><a href="<?php echo  site_url('bandook/packages_manage/package_edit/'.$package['package_id']);?>" >edit</a> /
		<a onclick="return confirm('Are you sure to delete package')" href="<?php echo  site_url('bandook/packages_manage/package_delete/'.$package['package_id']);?>" >delete</a>
	</td>
</tr>
<?php } } else { ?>
