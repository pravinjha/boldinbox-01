...
echo form_open('bandook/blog_banned_words/banned_create/', array('ban_id' => 'frmBannedWordsCreate'));
...
echo '&nbsp;';
echo form_button(array('name'=>'btnCancel','class'=>'inputbuttons', 'value'=>'Cancel','content'=>'Cancel','onclick'=>"window.location.href='".base_url().'bandook/blog_banned_words/banned_words_list'."'"));
echo "</td></tr>";
