...
?>
 ...
 <div style="text-align: right;"><a href="<?php echo base_url() ?>bandook/users_manage/subuser_create"><strong>Create Sub-User</strong></a></div>
...
<tr>
	...
	<ul style="list-style:disc;line-height:20px;margin:0 0 0 10px;padding:0;">		
		<li style="float:left;width:100px;"><a href="<?php echo  site_url('bandook/users_manage/subuser_create/'.$user['member_id']);?>" style="color:red;">Edit</a></li>
		<li style="float:left;width:100px;"><a onclick="return confirm('Are you sure to delete user')" href="<?php echo  site_url('bandook/users_manage/user_delete/'.$user['member_id']);?>" style="color:red;">Delete</a></li>
	</ul>
	</td>
</tr>
<?php } } else { ?>
