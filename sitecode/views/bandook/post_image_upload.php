<!--<script src="<?php echo $this->config->item('locker');?>js/jquery.js?v=6-20-13" type="text/javascript" language="javascript"></script>
<script src="<?php echo $this->config->item('locker');?>js/jquery.MultiFile.min.js?v=6-20-13" type="text/javascript" language="javascript"></script> -->
...
<?php
print_r($upload_data);
echo form_open_multipart('bandook/post_image_upload/do_upload/'.$post_id, array('id' => 'frmUpload'));
