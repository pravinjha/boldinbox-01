...
echo form_open_multipart('bandook/templates_manage/template_create', array('id' => 'form_template_create','name'=>'form_template_create'));
...
echo '&nbsp;';
echo form_button(array('name'=>'template_cancel','class'=>'inputbuttons', 'value'=>'Cancel','content'=>'Cancel','onclick'=>"window.location.href='".base_url().'bandook/templates_manage/templates_list'."'"));
echo '</td></tr>';
