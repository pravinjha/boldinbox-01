...
echo form_open('bandook/users_manage/user_add_package/'.$member_id, array('id' => 'frmPackages','name' => 'frmPackages'));
echo '<table><tr><td>';
?>
<table id="table1" class="tbl_listing" width="100%">
<tr><th>User</th><td><?php echo $user_data_array[0]['member_username'];?></td></tr>
<tr><th>Gateway</th><td><select name="gateway"><option value=''>--select--</option><option value='AUTHORIZE'>Authorize</option><option value='ADMIN'>ADMIN</option></td></tr>
