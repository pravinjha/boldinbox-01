	...
	$(document).ready(function() {
		jQuery('.show_on_dashboard').live('click',function(){
			if ($(this).attr('checked')) {
				var id=$(this).attr('id');
				jQuery.ajax({
				  url: "<?php echo base_url() ?>bandook/template_header/display_header_on_dashboard/"+id+"/1",
				  type:"POST",
				...
				var id=$(this).attr('id');
				jQuery.ajax({
				  url: "<?php echo base_url() ?>bandook/template_header/display_header_on_dashboard/"+id+"/0",
				  type:"POST",
				  success: function(data) {
				  }
				});
...
?>
 ...
 <div style="text-align: right;"><a href="<?php echo base_url() ?>bandook/template_header/header_create"><strong>Create New Template header</strong></a></div>
...
<tr>
	...
	<td width="20%">
		<img src="<?php  echo base_url()."locker/header-images/header-".$header['template_id'].".jpg"; ?>" alt="screenshot" />
	</td>
	<td width="15%">
	...
	<td width="30%">
		<a href="<?php echo  site_url('bandook/template_header/header_edit/'.$header['template_id']);?>" >edit</a> /
		<a onclick="return confirm('Are you sure to delete category')" href="<?php echo  site_url('bandook/template_header/header_delete/'.$header['template_id']);?>" >delete</a>
	</td>
</tr>
<?php } } else { ?>
