...
<?php
	if(count($user_transactions)&&(is_null($user['cancel_subscription_date']))) {
		echo "<a href='".site_url('bandook/users_manage/cancel_subscription/'.$member_id)."' style='float:right'>Cancel Subscription</a>";
	}
?>
</div>
...
<tr>
	...
	<td>
		<a href="<?php echo site_url("bandook/users_manage/billing_detail/".$transaction['transaction_id']);?>" target="_blank">#<?php echo $transaction['transaction_id'] ; ?></a>
	</td>
</tr>
<?php } } else { ?>
