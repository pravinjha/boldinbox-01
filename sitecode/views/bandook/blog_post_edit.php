...
echo form_open('bandook/blog_listing_post/post_edit/'.$cat_id.'/'.$category['id'], array('id' => 'frmCategoryEdit'));
...
echo '&nbsp;';
echo form_button(array('name'=>'btnCancel','class'=>'inputbuttons', 'value'=>'Cancel','content'=>'Cancel','onclick'=>"window.location.href='".base_url().'index.php/bandook/blog_listing_post/post_list/'.$cat_id."'"));
echo "</td></tr>";
