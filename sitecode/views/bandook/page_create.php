...
<?php
echo form_open('bandook/cms/page_create/'.$page['id'], array('id' => 'frmSeoCreate'));
...
echo '&nbsp;';
echo form_button(array('name'=>'btnCancel','class'=>'inputbuttons', 'value'=>'Cancel','content'=>'Cancel','onclick'=>"window.location.href='".base_url().'bandook/cms/page_list'."'"));
echo "</td></tr>";
