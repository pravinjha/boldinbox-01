...
?>
 ...
 <div style="text-align: right;"><a class="btn" href="<?php echo  site_url('bandook/post_image_upload/image_create/'.$post_id);?>"><strong>Add New Image</strong></a></div>
...
<tr>
	...
	<td>
		...
		?>
		<a onclick="return confirm('Are you sure to delete image')" href="<?php echo  site_url('bandook/post_image_upload/image_delete/'.$post_id.'/'.$categories['img_id']);?>" >delete</a>
