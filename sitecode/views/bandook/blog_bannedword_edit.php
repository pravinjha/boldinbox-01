...
echo form_open('bandook/blog_banned_words/banned_edit/'.$category['ban_id'], array('ban_id' => 'frmBannedWordsEdit'));
...
echo '&nbsp;';
echo form_button(array('name'=>'btnCancel','class'=>'inputbuttons', 'value'=>'Cancel','content'=>'Cancel','onclick'=>"window.location.href='".base_url().'index.php/bandook/blog_banned_words/banned_words_list'."'"));
echo "</td></tr>";
