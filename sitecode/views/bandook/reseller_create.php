...
echo form_open('bandook/reseller/reseller_create/', array('id' => 'frmResellerCreate'));
?>
<table class="tbl_forms">
	...
	<tr>		
		<td colspan="2">
			...
			echo '&nbsp;';
			echo form_button(array('name'=>'btnCancel','class'=>'inputbuttons', 'value'=>'Cancel','content'=>'Cancel','onclick'=>"window.location.href='".base_url().'bandook/reseller/'."'"));
			?>
		</td>		
	</tr> 	 
</table>
