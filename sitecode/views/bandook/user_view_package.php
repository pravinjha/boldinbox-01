...
echo form_open('bandook/users_manage/user_view_package/'.$member_id, array('id' => 'frmPackages','name' => 'frmPackages'));
...
<tr>
	...
	<td>	
		<a onclick="return confirm('Are you sure to delete package for this user')" href="<?php echo  site_url('bandook/users_manage/user_delete_package/'.$package['red_member_package_id'].'/'.$member_id);?>" >delete</a>
	</td>
...
?>
<br>
&laquo;<a href="<?php echo base_url() ?>bandook/users_manage/users_list">Back</a>
</center>