...
<?php $ci =& get_instance(); ?>
<form name="Src_frm" id="Src_frm" method="post" action="<?php echo base_url().'bandook/dashboard_stat/user_campaign_stats';?>">
...
<table class="tbl_listing" width="100%"> 
	...
	<tr>
		<td width="20%">		
		<a target="_blank" href="<?php echo CAMPAIGN_DOMAIN.'c/'.$this->is_authorized->encryptor('encrypt',$key); ?>" <?php if($email['is_deleted']==1) echo "style='color:#ff0000;'"?>><?php echo $email['campaign_title']; ?></a>
		<br/>
		...
		<td width="5%">
			<a class="fancybox" href="<?php echo  site_url("bandook/users_manage/view/".$email['member_id']); ?>"><?php echo $email['member_username'];  ?></a>
		</td>
		<td width="5%">
