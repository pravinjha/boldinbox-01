...
class Campaign_Autoresponder_Model extends CI_Model
{
	...
	function get_campaign_footer_diy($user, $email_campaign_id=0, $is_autoresponder=false, $is_address=false){	
		...
		if($is_autoresponder){			
			...
			//$emailtrack_img="<img border='0' src='".CAMPAIGN_DOMAIN."cprocess/opened/{$encode_camapign_id}/[subscriber_id]' width='".$rand_number."' height='".$rand_number."' alt='Read' /> ";			 
			//$emailtrack_img = $emailtrack_img."<img border='0' src='".base_url()."hitme/setme/' width='1' height='2' alt='seeit' /> ";			 
			 
			$emailtrack_img = "<img border='0' src='http://travelmistry.com/bib/check.php?abc={$encode_camapign_id}&pqr=[subscriber_id]' width='1' height='2' alt='seeit' /> "; 
