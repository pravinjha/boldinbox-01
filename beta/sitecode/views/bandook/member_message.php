...
<form name="frmAssignMessage" id="frmAssignMessage" method="post" action="<?php echo base_url() ?>bandook/manage_messages/assign_message/" >
...
<td><b>Message: </b></td><td><select name="mid" onchange="javascript:window.location.href='<?php echo base_url().'bandook/manage_messages/member_message/';?>'+this.value">
<?php
foreach($message_list as $msg_rec){
...
<tr>
	...
	<td>
		<a href="<?php echo  site_url('bandook/manage_messages/remove_member_message/'.$member_message['member_id'].'/'.$member_message['message_id']);?>" >Remove</a>
	</td>
</tr>
<?php } } else { ?>
