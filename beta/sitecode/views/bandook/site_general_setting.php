...
<?php
echo form_open('bandook/sitesetting_manage/general_setting/', array('id' => 'frmGeneralSetting'));
...
echo "</div></td></tr>";
echo "<tr><td valign='top'>Enable Strict Responsive<br/>(Strict Responsives will get mail only. By default it will be \"Disabled\")";
echo "</td><td> PMTA1 Pool1: " .form_dropdown('emergency_sending[]',array('yes'=>'Yes','no'=>'No'),$emergency_sending[0], "style='width:70px;'");
echo " PMTA1 Pool2: " .form_dropdown('emergency_sending[]',array('yes'=>'Yes','no'=>'No'),$emergency_sending[1], "style='width:70px;'");
echo " PMTA2 Pool1: " .form_dropdown('emergency_sending[]',array('yes'=>'Yes','no'=>'No'),$emergency_sending[2], "style='width:70px;'");
echo " PMTA2 Pool2: " .form_dropdown('emergency_sending[]',array('yes'=>'Yes','no'=>'No'),$emergency_sending[3], "style='width:70px;'");
echo '</td></tr>';

echo "<tr><td colspan='2'><hr /> </td></tr>";
echo "<tr><td colspan='2'>POOL DNM: (ex. value= gmail.com, @yahoo.,@aol)</td></tr>";

echo "<tr><td> PMTA1 Pool1: </td><td>" .form_input(array('name'=>'p1p1_dnm','id'=>'p1p1_dnm', 'value'=>$p1p1_dnm))."</td><tr>";
echo "<tr><td> PMTA1 Pool2: </td><td>" .form_input(array('name'=>'p1p2_dnm','id'=>'p1p2_dnm', 'value'=>$p1p2_dnm))."</td><tr>";
echo "<tr><td> PMTA2 Pool1: </td><td>" .form_input(array('name'=>'p2p1_dnm','id'=>'p2p1_dnm', 'value'=>$p2p1_dnm))."</td><tr>";
echo "<tr><td> PMTA2 Pool2: </td><td>" .form_input(array('name'=>'p2p2_dnm','id'=>'p2p2_dnm', 'value'=>$p2p2_dnm))."</td><tr>";
...
echo "<tr><td valign='top' width='40%'>Maximum Add Contact<br/>
