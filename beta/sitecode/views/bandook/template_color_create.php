...
<script type="text/javascript">
	...
	$('#btnEdit').live('click',function(){
		$('#frmCategoryCreate').submit();
	});
</script>
<div class="tblheading">Create New Template Color</div>
...
echo form_open('bandook/template_color/color_create/', array('id' => 'frmCategoryCreate'));
...
echo '&nbsp;';
echo form_button(array('name'=>'btnCancel','class'=>'inputbuttons', 'value'=>'Cancel','content'=>'Cancel','onclick'=>"window.location.href='".base_url().'bandook/template_color/template_color_list'."'"));
echo "</td></tr>";
