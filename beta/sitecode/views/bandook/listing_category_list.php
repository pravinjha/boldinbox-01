...
?>
 ...
 <div style="text-align: right;"><a href="<?php echo base_url() ?>bandook/listing_category/category_create"><strong>Create New Listing Category</strong></a></div>
...
<tr>
	...
	<?php }else{ ?>
		<a href="<?php echo  site_url('bandook/listing_category/category_create/'.$categories['listing_category_id']);?>" >Create Sub Category</a>
	<?php } ?>
	</td>
	
	<td>
		<a href="<?php echo  site_url('bandook/listing_category/category_edit/'.$categories['listing_category_id']);?>" >edit</a> /
		<?php 
			if($categories['delete']==1){
		?>
		<a onclick="return confirm('Are you sure to delete category')" href="<?php echo  site_url('bandook/listing_category/category_delete/'.$categories['listing_category_id']);?>" >delete</a>
		<?php } else{ ?>
