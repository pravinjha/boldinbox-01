...
<script type="text/javascript">
	jQuery('#btnFilter').live('click',function(){
			...
			$('#contacts').html("<img src='<?php echo $this->config->item('locker');?>images/ajax_loading.gif' width='220' height='19' />");
				...
				jQuery.ajax({
				  url: "<?php echo base_url() ?>bandook/contacts_segmentation/get_contacts_count/",
				  type:"post",
...
<td><?php echo form_input(array('name'=>'added_on_before','id'=>'added_on_before','maxlength'=>50,'size'=>38,'value'=>date('Y-m-d'))) ; ?>
			<SCRIPT type="text/javascript">
				$(function(){
