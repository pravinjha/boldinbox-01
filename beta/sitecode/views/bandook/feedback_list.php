...
<tr>
	...
	<td width="20%">
		<a href="<?php echo  site_url('bandook/feedback/message/'.$feedback['id']);?>" class="fancybox">Read more</a> / <a onclick="return confirm('Are you sure to delete feedback')" href="<?php echo  site_url('bandook/feedback/delete/'.$feedback['id']);?>">Delete</a>
	</td>
</tr>
<?php }
} else { ?>
