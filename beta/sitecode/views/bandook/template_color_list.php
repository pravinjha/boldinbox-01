...
?>
 ...
 <div style="text-align: right;"><a href="<?php echo base_url() ?>bandook/template_color/color_create"><strong>Create New Template Color</strong></a></div>
...
<tr>
	...
	<td width="15%">
		<a href="<?php echo  site_url('bandook/template_color/color_edit/'.$color['id']);?>" >edit</a> /	
		<a onclick="return confirm('Are you sure to delete template color')" href="<?php echo  site_url('bandook/template_color/color_delete/'.$color['id']);?>" >delete</a>	
	</td>
</tr>
<?php } } else { ?>
