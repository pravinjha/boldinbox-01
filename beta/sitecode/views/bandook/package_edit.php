...
echo form_open('bandook/packages_manage/package_edit/'.$package_id, array('id' => 'frmPackageCreate'));
?>
<table class="tbl_forms">
	...
	<tr>
		...
		<td >
			...
			echo '&nbsp;';
			echo form_button(array('name'=>'btnCancel','class'=>'inputbuttons', 'value'=>'Cancel','content'=>'Cancel','onclick'=>"window.location.href='".base_url().'bandook/packages_manage/packages_list'."'"));
			?>
		</td>
