...
echo form_open('bandook/support_category/support_category_edit/'.$category['id'], array('id' => 'frmCategoryEdit'));
...
echo '&nbsp;';
echo form_button(array('name'=>'btnCancel','class'=>'inputbuttons', 'value'=>'Cancel','content'=>'Cancel','onclick'=>"window.location.href='".base_url().'bandook/support_category/support_category_list'."'"));
echo "</td></tr>";
