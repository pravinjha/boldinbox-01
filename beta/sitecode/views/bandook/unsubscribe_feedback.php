...
<script type="text/javascript">
	...
	jQuery.ajax({
			url: "<?php echo base_url() ?>bandook/contacts_segmentation/showFeedback/"+mid+"/"+fid,
			type:"POST",
			data: "mode=authentic",
...
<form name="Src_frm" id="Src_frm" method="post" action="<?php echo base_url().'bandook/contacts_segmentation/unsubscribe_feedback';?>">
