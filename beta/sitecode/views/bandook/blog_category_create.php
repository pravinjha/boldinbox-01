...
echo form_open('bandook/blog_listing_category/category_create/', array('id' => 'frmCategoryCreate'));
...
echo '&nbsp;';
echo form_button(array('name'=>'btnCancel','class'=>'inputbuttons', 'value'=>'Cancel','content'=>'Cancel','onclick'=>"window.location.href='".base_url().'bandook/Blog_listing_category/category_list'."'"));
echo "</td></tr>";
