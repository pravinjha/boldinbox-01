...
<P ALIGN='center'><IFRAME SRC="<?php echo site_url('preview/index/'.$this->is_authorized->encryptor('encrypt',$campaign_id)) .'/y';?>"   title="<?php echo $campaign_data['email_subject'];?>" WIDTH='700' HEIGHT='600' FRAMEBORDER='0' SCROLLING='auto'></IFRAME></P></td></tr>
</table>
</div>
