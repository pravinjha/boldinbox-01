...
?>
 ...
 <div style="text-align: right;"><a href="<?php echo  site_url("bandook/templates_manage/template_create");?>">Create Template</a></div>
...
<tr>
	...
	<td>
		<a href="<?php echo  site_url('bandook/templates_manage/template_edit/'.$template['template_id']);?>" >edit</a> /
		<a onclick="return confirm('Are you sure to delete template')" href="<?php echo  site_url('bandook/templates_manage/template_delete/'.$template['template_id']);?>" >delete</a>
	</td>
</tr>
<?php }
} else { ?>
