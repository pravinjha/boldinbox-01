...
<?php
echo form_open_multipart('bandook/template_header/header_edit/'.$header['template_id'], array('id' => 'frmCategoryEdit'));
...
echo "<img src='". base_url()."locker/header-images/header-".$header['template_id'].".jpg' alt='screenshot' width='100'  />" ."<input type=\"file\" name=\"screenshot\" size=\"20\" /></td></tr>";
echo "<tr><td>";
...
echo '&nbsp;';
echo form_button(array('name'=>'btnCancel','class'=>'inputbuttons', 'value'=>'Cancel','content'=>'Cancel','onclick'=>"window.location.href='".base_url().'bandook/template_header/template_header_list'."'"));
echo "</td></tr>";
