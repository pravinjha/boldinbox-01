<form name="Src_frm" id="Src_frm" method="post" action="<?php echo ($user == 1) ? base_url().'bandook/users_manage/get_contacts/'.$user_id : base_url().'bandook/campaign/get_contacts/'.$id."/".$user_id;?>">
