...
?>
 ...
 <div style="text-align: right;"><a href="<?php echo base_url() ?>bandook/manage_messages/message_create"><strong>Create New Message</strong></a></div>
...
<tr>
	...
	<td>
		<a href="<?php echo  site_url('bandook/manage_messages/message_edit/'.$messages['message_id']);?>" >edit</a>
	</td>
</tr>
<?php } } else { ?>
