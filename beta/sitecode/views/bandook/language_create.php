...
echo form_open('bandook/language_manage/language_create/', array('id' => 'frmCategoryCreate'));
...
echo '&nbsp;';
echo form_button(array('name'=>'btnCancel','class'=>'inputbuttons', 'value'=>'Cancel','content'=>'Cancel','onclick'=>"window.location.href='".base_url().'bandook/language_manage/language_list'."'"));
echo "</td></tr>";
