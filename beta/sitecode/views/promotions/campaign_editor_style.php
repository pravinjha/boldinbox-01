...
foreach($arrCssFiles as $cssfile){
		$css_output .= (file_get_contents(FCFOLDER . 'locker/'.$cssfile))."\n\n\n";
		$modified_time = max(filemtime(FCFOLDER . 'locker/'.$cssfile), $modified_time);
}
...
.empty_block
{
	background:url("../../../locker/images/contentBuilderEmailContentBG.jpg?v=1.0") no-repeat scroll center center transparent;
	width:100%;
	height:300px;
...
ul.handler li.drag-center,ul.handler li.li_bgcolor{ float:none !important; text-align: center !important; margin:0 auto !important ;width:100px;}


ul.handler li.drag-center a,ul.handler li.li_bgcolor a{ float:left !important; text-align:center !important; margin:0 auto !important ;width:20px;}

//ul.handler li.alignright{ position:absolute; right:-13px; top:15px; float:none !important; text-align: center !important; margin:0 auto !important ;}
//ul.handler li.drag-center{ position:absolute; right:-12px; top:90px; float:none !important; text-align: center !important; margin:0 auto !important ;}
//ul.handler li.drag-center a{ float:none !important; text-align:center !important; margin:0 auto !important ;}

//ul.handler li.li_bgcolor{ position:absolute; right:-15px; top:70px; float:none !important; text-align: center !important; margin:0 auto !important ;}
