...
class User_Notification extends CI_Controller
{
	...
	function display($start=0)
	{
		...
		$this->load->view('bandook/header',array('title'=>'Manage Users Notifications','logo_link'=>$logo_link));
		$this->load->view('bandook/user_notification_list',array('users'=>$user_data_array));
	...
	function user_edit($id)
	{
		...
		$this->load->view('bandook/user_edit',array('user'=>$user_data_array,'messages' =>$messages));
		$this->load->view('bandook/footer');
	}
	...
	function user_create()
	{
		...
		$this->load->view('bandook/user_create',array('user'=>$user_data_array,'messages' =>$messages));
		$this->load->view('bandook/footer');
	}
	...
	function user_add_package($id)
	{
		...
		$this->load->view('bandook/user_add_package',array('packages'=>$packages,'user_packages'=>$user_packages,'messages' =>$messages,'member_id'=>$id));
		$this->load->view('bandook/footer');
	}
