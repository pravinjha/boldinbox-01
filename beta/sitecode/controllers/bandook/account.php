...
class Account extends CI_Controller
{
	...
	*/
	...
	function login()
	{
			...
			if($this->form_validation->run()==true)
			{
				...
				if(count($user_data_array))
				{
					...
					if(get_cookie('rc_referal_url')!=""){
						...
						redirect('bandook/dashboard_stat');
					}else{
		...
		$this->load->view('bandook/header',array('title'=>'Webmaster Login','logo_link'=>$logo_link));
		$this->load->view('bandook/account_login',array('user'=>$user_data_array,'messages' =>$messages));
