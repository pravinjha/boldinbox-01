...
class Contacts_segmentation extends CI_Controller
{
	...
	set_time_limit(0); 
		...
		if($rsMembersToTrack ->num_rows() > 0){
			...
			https://www.boldinbox.com/bandook/contacts_unresponsive/0/10/ <br/>
			https://www.boldinbox.com/bandook/contacts_unresponsive/10/10/ <br/>
			<br/>
			by default it is <br/>
			https://www.boldinbox.com/bandook/contacts_unresponsive/0/10
			</p>".
		...
		$this->load->view('bandook/header',array('title'=>'Report unresponsive','logo_link'=>"bandook/dashboard_stat"));
		$this->load->view('bandook/contacts_unresponsive',array('strTable'=>$strTable));
		$this->load->view('bandook/footer');
	}
