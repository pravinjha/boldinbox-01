...
//		$header_html='<!DOCTYPE html><html>
		...
		<head><title>BoldInbox Campaign</title><meta http-equiv="content-type" content="text/html; charset=UTF-8" /> 
		<style type="text/css">
		...
		.youtube_image_caption,	.image_caption{padding-bottom:0px;padding-left:0px;display:block;text-align:center;font-size:11px} 
		.edit_offer{padding-top:10px;padding-right:10px;padding-bottom:10px;padding-left:10px;}
		 ...
		 //exit;
			...
			}elseif(stripos($campaign_title, 'campaign ')=== FALSE){
