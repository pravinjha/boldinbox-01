  ...
  */
  ...
  function updateLanguage(target) {
    ...
    jQuery.ajax({
        url: base_url+"signup/signup_translate",
        type:"POST",
        data:{
          language: target,
...
block_data+="&fld_sequence="+$('#form_preview').find('input').serialize();
    jQuery.ajax({
      url: base_url+"signup/signup_edit/"+sid+"/true/ajax/",
       type:"POST",
      data: block_data,
      success: function(data) {
    $.unblockUI();
      ...
      if(showCode){
        // submit_custom_message();
         jQuery.ajax({
          url: base_url+"signup/subscribe/"+sid+"/code",
          type:"POST",
          success: function(data) {
  ...
  function submit_custom_message() {
    ...
    jQuery.ajax({
      url: base_url+"signup/signup_custom_frm/"+sid,
       type:"POST",
      data:block_data,
      success: function(data) {
        var data_arr=data.split(":", 2);
  ...
  */
  ...
  jQuery('#add_btn').live('click',function(){
    ...
    jQuery('#btn_file').upload(base_url+'ajax/signup_background_img/btn/', function(res) {
      ...
      if(image_obj[0] == 'noerr'){
		...
		//else fancyAlert('<div class="signup-tbl-file-error"><i class="icon-lightbulb"></i>'+image_obj[1]+'</div>');
      }
  ...
  $.blockUI({ message: '<h3 class="please-wait">Please wait...</h3>' });
  jQuery.ajax({
      url: base_url+"signup/getAdvanced/",
      type:"POST",
      success: function(data) {
